(()=>{var Re=Object.defineProperty;var le=(c,t)=>()=>(c&&(t=c(c=0)),t);var ce=(c,t)=>{for(var e in t)Re(c,e,{get:t[e],enumerable:!0})};var ge={};ce(ge,{$Bitmap:()=>Ve,$Font:()=>He,$Glyph:()=>Ne,Bitmap:()=>Y,Font:()=>It,Glyph:()=>W});var tt,Ae,De,ue,Fe,Be,ze,Ct,It,W,Y,He,Ne,Ve,me=le(()=>{tt=function(c,t,e,i){function s(o){return o instanceof e?o:new e(function(n){n(o)})}return new(e||(e=Promise))(function(o,n){function r(d){try{l(i.next(d))}catch(h){n(h)}}function a(d){try{l(i.throw(d))}catch(h){n(h)}}function l(d){d.done?o(d.value):s(d.value).then(r,a)}l((i=i.apply(c,t||[])).next())})},Ae=function(c){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var t=c[Symbol.asyncIterator],e;return t?t.call(c):(c=typeof __values=="function"?__values(c):c[Symbol.iterator](),e={},i("next"),i("throw"),i("return"),e[Symbol.asyncIterator]=function(){return this},e);function i(o){e[o]=c[o]&&function(n){return new Promise(function(r,a){n=c[o](n),s(r,a,n.done,n.value)})}}function s(o,n,r,a){Promise.resolve(a).then(function(l){o({value:l,done:r})},n)}},De=(c,t,e)=>{c[t]=e},ue="[\\s]+",Fe={glyphname:"empty",codepoint:8203,bbw:0,bbh:0,bbxoff:0,bbyoff:0,swx0:0,swy0:0,dwx0:0,dwy0:0,swx1:0,swy1:0,dwx1:0,dwy1:0,vvectorx:0,vvectory:0,hexdata:[]},Be=["glyphname","codepoint","bbw","bbh","bbxoff","bbyoff","swx0","swy0","dwx0","dwy0","swx1","swy1","dwx1","dwy1","vvectorx","vvectory","hexdata"],ze={lr:"lrtb",rl:"rltb",tb:"tbrl",bt:"btrl",lrtb:void 0,lrbt:void 0,rltb:void 0,rlbt:void 0,tbrl:void 0,tblr:void 0,btrl:void 0,btlr:void 0},Ct={lr:1,rl:2,tb:0,bt:-1},It=class{constructor(){this.headers=void 0,this.__headers={},this.props={},this.glyphs=new Map,this.__glyph_count_to_check=null,this.__curline_startchar=null,this.__curline_chars=null}load_filelines(t){var e,i;return tt(this,void 0,void 0,function*(){try{this.__f=t,yield this.__parse_headers()}finally{if(typeof Deno<"u"&&this.__f!==void 0)try{for(var s=Ae(this.__f),o;o=yield s.next(),!o.done;){let n=o.value}}catch(n){e={error:n}}finally{try{o&&!o.done&&(i=s.return)&&(yield i.call(s))}finally{if(e)throw e.error}}}return this})}__parse_headers(){var t,e;return tt(this,void 0,void 0,function*(){for(;;){let i=(e=yield(t=this.__f)===null||t===void 0?void 0:t.next())===null||e===void 0?void 0:e.value,s=i.split(/ (.+)/,2),o=s.length,n;if(o===2){let r=s[0],a=s[1].trim();switch(r){case"STARTFONT":this.__headers.bdfversion=parseFloat(a);break;case"FONT":this.__headers.fontname=a;break;case"SIZE":n=a.split(" "),this.__headers.pointsize=parseInt(n[0],10),this.__headers.xres=parseInt(n[1],10),this.__headers.yres=parseInt(n[2],10);break;case"FONTBOUNDINGBOX":n=a.split(" "),this.__headers.fbbx=parseInt(n[0],10),this.__headers.fbby=parseInt(n[1],10),this.__headers.fbbxoff=parseInt(n[2],10),this.__headers.fbbyoff=parseInt(n[3],10);break;case"STARTPROPERTIES":this.__parse_headers_after(),yield this.__parse_props();return;case"COMMENT":(!("comment"in this.__headers)||!Array.isArray(this.__headers.comment))&&(this.__headers.comment=[]),this.__headers.comment.push(a.replace(/^[\s"'\t\r\n]+|[\s"'\t\r\n]+$/g,""));break;case"SWIDTH":n=a.split(" "),this.__headers.swx0=parseInt(n[0],10),this.__headers.swy0=parseInt(n[1],10);break;case"DWIDTH":n=a.split(" "),this.__headers.dwx0=parseInt(n[0],10),this.__headers.dwy0=parseInt(n[1],10);break;case"SWIDTH1":n=a.split(" "),this.__headers.swx1=parseInt(n[0],10),this.__headers.swy1=parseInt(n[1],10);break;case"DWIDTH1":n=a.split(" "),this.__headers.dwx1=parseInt(n[0],10),this.__headers.dwy1=parseInt(n[1],10);break;case"VVECTOR":n=ue.split(a),this.__headers.vvectorx=parseInt(n[0],10),this.__headers.vvectory=parseInt(n[1],10);break;case"METRICSSET":case"CONTENTVERSION":this.__headers[r.toLowerCase()]=parseInt(a,10);break;case"CHARS":console.warn("It looks like the font does not have property block beginning with 'STARTPROPERTIES' keyword"),this.__parse_headers_after(),this.__curline_chars=i,yield this.__parse_glyph_count();return;case"STARTCHAR":console.warn("It looks like the font does not have property block beginning with 'STARTPROPERTIES' keyword"),console.warn("Cannot find 'CHARS' line"),this.__parse_headers_after(),this.__curline_startchar=i,yield this.__prepare_glyphs();return}}if(o===1&&s[0].trim()==="ENDFONT"){console.warn("It looks like the font does not have property block beginning with 'STARTPROPERTIES' keyword"),console.warn("This font does not have any glyphs");return}}})}__parse_headers_after(){"metricsset"in this.__headers||(this.__headers.metricsset=0),this.headers=this.__headers}__parse_props(){var t,e;return tt(this,void 0,void 0,function*(){for(;;){let s=((e=yield(t=this.__f)===null||t===void 0?void 0:t.next())===null||e===void 0?void 0:e.value).split(/ (.+)/,2),o=s.length;if(o===2){let n=s[0],r=s[1].replace(/^[\s"'\t\r\n]+|[\s"'\t\r\n]+$/g,"");n==="COMMENT"?((!("comment"in this.props)||!Array.isArray(this.props.comment))&&(this.props.comment=[]),this.props.comment.push(r.replace(/^[\s"'\t\r\n]+|[\s"'\t\r\n]+$/g,""))):this.props[n.toLowerCase()]=r}else if(o===1){let n=s[0].trim();if(n==="ENDPROPERTIES"){yield this.__parse_glyph_count();return}if(n==="ENDFONT"){console.warn("This font does not have any glyphs");return}else this.props[n]=null}}})}__parse_glyph_count(){var t,e;return tt(this,void 0,void 0,function*(){let i;if(this.__curline_chars===null?i=(e=yield(t=this.__f)===null||t===void 0?void 0:t.next())===null||e===void 0?void 0:e.value:(i=this.__curline_chars,this.__curline_chars=null),i.trim()==="ENDFONT"){console.warn("This font does not have any glyphs");return}let s=i.split(/ (.+)/,2);s[0]==="CHARS"?this.__glyph_count_to_check=parseInt(s[1].trim(),10):(this.__curline_startchar=i,console.warn("Cannot find 'CHARS' line next to 'ENDPROPERTIES' line")),yield this.__prepare_glyphs()})}__prepare_glyphs(){var t,e;return tt(this,void 0,void 0,function*(){let i=0,s=[null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],o=[],n=!1,r=!1;for(;;){let a;if(this.__curline_startchar===null?a=(e=yield(t=this.__f)===null||t===void 0?void 0:t.next())===null||e===void 0?void 0:e.value:(a=this.__curline_startchar,this.__curline_startchar=null),a==null){console.warn("This font does not have 'ENDFONT' keyword"),this.__prepare_glyphs_after();return}let l=a.split(/ (.+)/,2),d=l.length;if(d===2){let h=l[0],f=l[1].trim(),p;switch(h){case"STARTCHAR":s=[null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],s[0]=f,r=!1;break;case"ENCODING":i=parseInt(f,10),s[1]=i;break;case"BBX":p=f.split(" "),s[2]=parseInt(p[0],10),s[3]=parseInt(p[1],10),s[4]=parseInt(p[2],10),s[5]=parseInt(p[3],10);break;case"SWIDTH":p=f.split(" "),s[6]=parseInt(p[0],10),s[7]=parseInt(p[1],10);break;case"DWIDTH":p=f.split(" "),s[8]=parseInt(p[0],10),s[9]=parseInt(p[1],10);break;case"SWIDTH1":p=f.split(" "),s[10]=parseInt(p[0],10),s[11]=parseInt(p[1],10);break;case"DWIDTH1":p=f.split(" "),s[12]=parseInt(p[0],10),s[13]=parseInt(p[1],10);break;case"VVECTOR":p=ue.split(f),s[14]=parseInt(p[0],10),s[15]=parseInt(p[1],10);break}}else if(d===1){let h=l[0].trim();switch(h){case"BITMAP":o=[],n=!0;break;case"ENDCHAR":n=!1,s[16]=o,this.glyphs.set(i,s),r=!0;break;case"ENDFONT":if(r){this.__prepare_glyphs_after();return}default:n&&o.push(h);break}}}})}__prepare_glyphs_after(){let t=this.glyphs.size;this.__glyph_count_to_check!==t&&(this.__glyph_count_to_check===null?console.warn("The glyph count next to 'CHARS' keyword does not exist"):console.warn(`The glyph count next to 'CHARS' keyword is ${this.__glyph_count_to_check.toString()}, which does not match the actual glyph count ${t.toString()}`))}get length(){return this.glyphs.size}itercps(t,e){let i=t??1,s=e??null,o,n=[...this.glyphs.keys()];switch(i){case 1:o=n.sort((r,a)=>r-a);break;case 0:o=n;break;case 2:o=n.sort((r,a)=>a-r);break;case-1:o=n.reverse();break}if(s!==null){let r=a=>{if(typeof s=="number")return a<s;if(Array.isArray(s)&&s.length===2&&typeof s[0]=="number"&&typeof s[1]=="number")return a<=s[1]&&a>=s[0];if(Array.isArray(s)&&Array.isArray(s[0]))for(let l of s){let[d,h]=l;if(a<=h&&a>=d)return!0}return!1};o=o.filter(r)}return o}*iterglyphs(t,e){for(let i of this.itercps(t,e))yield this.glyphbycp(i)}glyphbycp(t){let e=this.glyphs.get(t);if(e==null)return console.warn(`Glyph "${String.fromCodePoint(t)}" (codepoint ${t.toString()}) does not exist in the font. Will return 'null'`),null;{let i={};return Be.forEach((s,o)=>{De(i,s,e[o])}),new W(i,this)}}glyph(t){let e=t.codePointAt(0);return e===void 0?null:this.glyphbycp(e)}lacksglyphs(t){let e=[],i=t.length;for(let s,o=0;o<i;o++){s=t[o];let n=s.codePointAt(0);(n===void 0||!this.glyphs.has(n))&&e.push(s)}return e.length!==0?e:null}drawcps(t,e={}){var i,s,o,n,r,a,l;let d=(i=e.linelimit)!==null&&i!==void 0?i:512,h=(s=e.mode)!==null&&s!==void 0?s:1,f=(o=e.direction)!==null&&o!==void 0?o:"lrtb",p=(n=e.usecurrentglyphspacing)!==null&&n!==void 0?n:!1,u=(r=e.missing)!==null&&r!==void 0?r:null;if(this.headers===void 0)throw new Error("Font is not loaded");let g,b,m,x,_,v,y,k,w,C,S,T,I,M,Q,xt,yt,wt,ie=(a=ze[f])!==null&&a!==void 0?a:f,se=ie.slice(0,2),oe=ie.slice(2,4);se in Ct&&oe in Ct?(v=Ct[se],y=Ct[oe]):(v=1,y=0),y===0||y===2?g=1:(y===1||y===-1)&&(g=0),v===1||v===-1?b=1:(v===2||v===0)&&(b=0),h===1&&(k=v>0?this.headers.fbbx:this.headers.fbby,v>0?(T="dwx0",I="dwy0"):(T="dwx1",I="dwy1"),T in this.headers?S=this.headers[T]:I in this.headers?S=this.headers[I]:S=null);let ne=[];x=[];let ae=[];Q=[],xt=0;let re=()=>{ne.push(x),p?Q.shift():Q.pop(),ae.push(Q)},ke=t[Symbol.iterator]();for(yt=!1;;){if(yt)yt=!1;else{if(_=(l=ke.next())===null||l===void 0?void 0:l.value,_===void 0)break;let St=this.glyphbycp(_);St!==null?w=St:u?u instanceof W?w=u:w=new W(u,this):w=new W(Fe,this),m=w.draw(),wt=m.width(),M=0,h===1&&T!==void 0&&I!==void 0&&(C=w.meta[T]||w.meta[I],C==null&&(C=S),C!=null&&k!==void 0&&(M=C-k))}if(wt!==void 0&&M!==void 0&&m!==void 0&&w!==void 0&&_!==void 0)if(xt+=wt+M,xt<=d)x.push(m),Q.push(M);else{if(x.length===0)throw new Error(`\`_linelimit\` (${d}) is too small the line can't even contain one glyph: "${w.chr()}" (codepoint ${_}, width: ${wt})`);re(),xt=0,x=[],Q=[],yt=!0}}x.length!==0&&re();let Me=ne.map((St,$e)=>Y.concatall(St,{direction:v,align:g,offsetlist:ae[$e]}));return Y.concatall(Me,{direction:y,align:b})}draw(t,e={}){let{linelimit:i,mode:s,direction:o,usecurrentglyphspacing:n,missing:r}=e;return this.drawcps(t.split("").map(a=>{let l=a.codePointAt(0);return l===void 0?8203:l}),{linelimit:i,mode:s,direction:o,usecurrentglyphspacing:n,missing:r})}drawall(t={}){let{order:e,r:i,linelimit:s,mode:o,direction:n,usecurrentglyphspacing:r}=t,a=o??0;return this.drawcps(this.itercps(e,i),{linelimit:s,mode:a,direction:n,usecurrentglyphspacing:r})}},W=class{constructor(t,e){this.meta=t,this.font=e}toString(){return this.draw().toString()}repr(){var t;return"Glyph("+JSON.stringify(this.meta,null,2)+", Font(<"+((t=this.font.headers)===null||t===void 0?void 0:t.fontname)+">)"}cp(){return this.meta.codepoint}chr(){return String.fromCodePoint(this.cp())}draw(t,e){let i=t??0,s=e??null,o;switch(i){case 0:o=this.__draw_fbb();break;case 1:o=this.__draw_bb();break;case 2:o=this.__draw_original();break;case-1:if(s!==null)o=this.__draw_user_specified(s);else throw new Error("Parameter bb in draw() method must be set when mode=-1");break}return o}__draw_user_specified(t){let e=this.meta.bbxoff,i=this.meta.bbyoff,[s,o,n,r]=t;return this.__draw_bb().crop(s,o,-e+n,-i+r)}__draw_original(){return new Y(this.meta.hexdata.map(t=>t?parseInt(t,16).toString(2).padStart(t.length*4,"0"):""))}__draw_bb(){let t=this.meta.bbw,e=this.meta.bbh,i=this.__draw_original(),s=i.bindata,o=s.length;return o!==e&&console.warn(`Glyph "${this.meta.glyphname.toString()}" (codepoint ${this.meta.codepoint.toString()})'s bbh, ${e.toString()}, does not match its hexdata line count, ${o.toString()}`),i.bindata=s.map(n=>n.slice(0,t)),i}__draw_fbb(){let t=this.font.headers;if(t===void 0)throw new Error("Font is not loaded");return this.__draw_user_specified([t.fbbx,t.fbby,t.fbbxoff,t.fbbyoff])}origin(t={}){var e,i,s,o;let n=(e=t.mode)!==null&&e!==void 0?e:0,r=(i=t.fromorigin)!==null&&i!==void 0?i:!1,a=(s=t.xoff)!==null&&s!==void 0?s:null,l=(o=t.yoff)!==null&&o!==void 0?o:null,d,h=this.meta.bbxoff,f=this.meta.bbyoff;switch(n){case 0:let p=this.font.headers;if(p===void 0)throw new Error("Font is not loaded");d=[p.fbbxoff,p.fbbyoff];break;case 1:d=[h,f];break;case 2:d=[h,f];break;case-1:if(a!==null&&l!==null)d=[a,l];else throw new Error("Parameter xoff and yoff in origin() method must be all set when mode=-1");break}return r?d:[0-d[0],0-d[1]]}},Y=class c{constructor(t){this.bindata=t}toString(){return this.bindata.join(`
`).replace(/0/g,".").replace(/1/g,"#").replace(/2/g,"&")}repr(){return`Bitmap(${JSON.stringify(this.bindata,null,2)})`}width(){return this.bindata[0].length}height(){return this.bindata.length}clone(){return new c([...this.bindata])}static __crop_string(t,e,i){let s=t,o=t.length,n=0;e<0&&(n=0-e,s=s.padStart(n+o,"0")),e+i>o&&(s=s.padEnd(e+i-o+s.length,"0"));let r=e+n;return s.slice(r,r+i)}static __string_offset_concat(t,e,i){let s=i??0;if(s===0)return t+e;let o=t.length,n=e.length,r=o+s,a=r+n,l=Math.min(0,r),d=Math.max(o,a),h=c.__crop_string(t,l,d-l),f=c.__crop_string(e,l-r,d-l);return h.split("").map((p,u)=>(parseInt(f[u],10)||parseInt(p,10)).toString()).join("")}static __listofstr_offset_concat(t,e,i){let s=i??0,o,n;if(s===0)return t.concat(e);let r=t[0].length,a=t.length,l=e.length,d=a+s,h=d+l,f=Math.min(0,d),p=Math.max(a,h),u=[];for(let g=f;g<p;g++)g<0||g>=a?o="0".repeat(r):o=t[g],g<d||g>=h?n="0".repeat(r):n=e[g-d],u.push(o.split("").map((b,m)=>(parseInt(n[m],10)||parseInt(b,10)).toString()).join(""));return u}static __crop_bitmap(t,e,i,s,o){let n,r=[],a=t.length;for(let l=0;l<i;l++)n=a-o-i+l,n<0||n>=a?r.push("0".repeat(e)):r.push(c.__crop_string(t[n],s,e));return r}crop(t,e,i,s){let o=i??0,n=s??0;return this.bindata=c.__crop_bitmap(this.bindata,t,e,o,n),this}overlay(t){let e=this.bindata,i=t.bindata;return e.length!==i.length&&console.warn("the bitmaps to overlay have different height"),e[0].length!==i[0].length&&console.warn("the bitmaps to overlay have different width"),this.bindata=e.map((s,o)=>{let n=s,r=i[o];return n.split("").map((a,l)=>(parseInt(r[l],10)||parseInt(a,10)).toString()).join("")}),this}static concatall(t,e={}){var i,s,o;let n=(i=e.direction)!==null&&i!==void 0?i:1,r=(s=e.align)!==null&&s!==void 0?s:1,a=(o=e.offsetlist)!==null&&o!==void 0?o:null,l,d,h,f,p,u,g;if(n>0){h=Math.max(...t.map(m=>m.height())),p=Array(h).fill("");let b=(m,x,_)=>n===1?c.__string_offset_concat(m,x,_):c.__string_offset_concat(x,m,_);for(let m=0;m<h;m++){r?d=-m-1:d=m,f=0;let x=t.length;for(let _=0;_<x;_++){let v=t[_];a&&_!==0&&(f=a[_-1]),m<v.height()?d>=0?p[d]=b(p[d],v.bindata[d],f):p[h+d]=b(p[h+d],v.bindata[v.height()+d],f):d>=0?p[d]=b(p[d],"0".repeat(v.width()),f):p[h+d]=b(p[h+d],"0".repeat(v.width()),f)}}}else{h=Math.max(...t.map(m=>m.width())),p=[],f=0;let b=t.length;for(let m=0;m<b;m++){let x=t[m];a&&m!==0&&(f=a[m-1]),l=x.bindata,u=x.width(),u!==h&&(r?g=0:g=u-h,l=this.__crop_bitmap(l,h,x.height(),g,0)),n===0?p=c.__listofstr_offset_concat(p,l,f):p=c.__listofstr_offset_concat(l,p,f)}}return new this(p)}concat(t,e={}){let{direction:i,align:s,offset:o}=e,n=o??0;return this.bindata=c.concatall([this,t],{direction:i,align:s,offsetlist:[n]}).bindata,this}static __enlarge_bindata(t,e,i){let s=e??1,o=i??1,n=[...t];return s>1&&(n=n.map(r=>r.split("").reduce((a,l)=>a.concat(Array(s).fill(l)),[]).join(""))),o>1&&(n=n.reduce((r,a)=>r.concat(Array(o).fill(a)),[])),n}enlarge(t,e){return this.bindata=c.__enlarge_bindata(this.bindata,t,e),this}replace(t,e){let i=typeof t=="number"?t.toString():t,s=typeof e=="number"?e.toString():e,o=(n,r,a)=>{if("replaceAll"in String.prototype)return n.replaceAll(r,a);{let l=d=>d.replace(/[.*+\-?^${}()|[\]\\]/g,"\\$&");return n.replace(new RegExp(l(r),"g"),a)}};return this.bindata=this.bindata.map(n=>o(n,i,s)),this}shadow(t,e){let i=t??1,s=e??-1,o,n,r,a,l,d,h=this.clone();return d=this.width(),o=this.height(),d+=Math.abs(i),o+=Math.abs(s),h.bindata=h.bindata.map(f=>f.replace(/1/g,"2")),i>0?(n=0,a=-i):(n=i,a=0),s>0?(r=0,l=-s):(r=s,l=0),this.crop(d,o,n,r),h.crop(d,o,a,l),h.overlay(this),this.bindata=h.bindata,this}glow(t){var e,i,s,o,n,r,a,l,d,h,f,p,u,g;let b=t??0,m,x,_,v;_=this.width(),v=this.height(),_+=2,v+=2,this.crop(_,v,-1,-1);let y=this.todata(2),k=y.length;for(let w=0;w<k;w++){m=y[w];let C=m.length;for(let S=0;S<C;S++)x=m[S],x===1&&((e=y[w])[i=S-1]||(e[i]=2),(s=y[w])[o=S+1]||(s[o]=2),(n=y[w-1])[S]||(n[S]=2),(r=y[w+1])[S]||(r[S]=2),b===1&&((a=y[w-1])[l=S-1]||(a[l]=2),(d=y[w-1])[h=S+1]||(d[h]=2),(f=y[w+1])[p=S-1]||(f[p]=2),(u=y[w+1])[g=S+1]||(u[g]=2)))}return this.bindata=y.map(w=>w.map(C=>C.toString()).join("")),this}bytepad(t){let e=t??8,i=this.width(),s=this.height(),o=i%e;return o===0?this:this.crop(i+e-o,s)}todata(t){let e=t??1,i;switch(e){case 0:i=this.bindata.join(`
`);break;case 1:i=this.bindata;break;case 2:i=this.bindata.map(s=>s.split("").map(o=>parseInt(o,10)));break;case 3:i=[].concat(...this.todata(2));break;case 4:i=this.bindata.map(s=>{if(!/^[01]+$/.test(s))throw new Error(`Invalid binary string: ${s}`);return parseInt(s,2).toString(16).padStart(Math.floor(-1*this.width()/4)*-1,"0")});break;case 5:i=this.bindata.map(s=>{if(!/^[01]+$/.test(s))throw new Error(`Invalid binary string: ${s}`);return parseInt(s,2)});break}return i}draw2canvas(t,e){let i=e??{0:null,1:"black",2:"red"};return this.todata(2).forEach((s,o)=>{s.forEach((n,r)=>{let a=n.toString();if(a==="0"||a==="1"||a==="2"){let l=i[a];l!=null&&(t.fillStyle=l,t.fillRect(r,o,1,1))}})}),this}},He=c=>tt(void 0,void 0,void 0,function*(){return yield new It().load_filelines(c)}),Ne=(c,t)=>new W(c,t),Ve=c=>new Y(c)});var be={};ce(be,{default:()=>We});function We(c,{includeLastEmptyLine:t=!0,encoding:e="utf-8",delimiter:i=/\r?\n/g}={}){return Xe(this,arguments,function*(){let o=yield q(Ue(c)),{value:n,done:r}=yield q(o.read()),a=new TextDecoder(e),l=n?a.decode(n):"",d;if(typeof i=="string"){if(i==="")throw new Error("delimiter cannot be empty string!");d=new RegExp(je(i),"g")}else/g/.test(i.flags)===!1?d=new RegExp(i.source,i.flags+"g"):d=i;let h=0;for(;;){let f=d.exec(l);if(f===null){if(r===!0)break;let p=l.substring(h);({value:n,done:r}=yield q(o.read())),l=p+(l?a.decode(n):""),h=0;continue}yield yield q(l.substring(h,f.index)),h=d.lastIndex}(t||h<l.length)&&(yield yield q(l.substring(h)))})}var Ge,q,Xe,je,Ue,_e=le(()=>{Ge=function(c,t,e,i){function s(o){return o instanceof e?o:new e(function(n){n(o)})}return new(e||(e=Promise))(function(o,n){function r(d){try{l(i.next(d))}catch(h){n(h)}}function a(d){try{l(i.throw(d))}catch(h){n(h)}}function l(d){d.done?o(d.value):s(d.value).then(r,a)}l((i=i.apply(c,t||[])).next())})},q=function(c){return this instanceof q?(this.v=c,this):new q(c)},Xe=function(c,t,e){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var i=e.apply(c,t||[]),s,o=[];return s={},n("next"),n("throw"),n("return"),s[Symbol.asyncIterator]=function(){return this},s;function n(f){i[f]&&(s[f]=function(p){return new Promise(function(u,g){o.push([f,p,u,g])>1||r(f,p)})})}function r(f,p){try{a(i[f](p))}catch(u){h(o[0][3],u)}}function a(f){f.value instanceof q?Promise.resolve(f.value.v).then(l,d):h(o[0][2],f)}function l(f){r("next",f)}function d(f){r("throw",f)}function h(f,p){f(p),o.shift(),o.length&&r(o[0][0],o[0][1])}},je=c=>c.replace(/[.*+\-?^${}()|[\]\\]/g,"\\$&"),Ue=c=>Ge(void 0,void 0,void 0,function*(){let t=yield fetch(c);if(t.body===null)throw new Error("Cannot read file");return t.body.getReader()})});var de="2.11.1";var he="iPIXEL_DisplayState",fe="iPIXEL_TestMode",Le={text:"",mode:"text",effect:"fixed",speed:50,fgColor:"#ff6600",bgColor:"#000000",font:"VCR_OSD_MONO",lastUpdate:0};function Oe(){try{let c=localStorage.getItem(he);if(c)return JSON.parse(c)}catch(c){console.warn("iPIXEL: Could not load saved state",c)}return{...Le}}function Pe(c){try{localStorage.setItem(he,JSON.stringify(c))}catch(t){console.warn("iPIXEL: Could not save state",t)}}window.iPIXELDisplayState||(window.iPIXELDisplayState=Oe());function F(){return window.iPIXELDisplayState}function E(c){return window.iPIXELDisplayState={...window.iPIXELDisplayState,...c,lastUpdate:Date.now()},Pe(window.iPIXELDisplayState),window.dispatchEvent(new CustomEvent("ipixel-display-update",{detail:window.iPIXELDisplayState})),window.iPIXELDisplayState}function U(){if(window.iPIXELTestMode!==void 0)return window.iPIXELTestMode;try{return localStorage.getItem(fe)==="true"}catch{return!1}}function Et(c){window.iPIXELTestMode=c;try{localStorage.setItem(fe,String(c))}catch{}window.dispatchEvent(new CustomEvent("ipixel-test-mode-change",{detail:{enabled:c}}))}function H(c,t=null){let e=()=>typeof t=="function"?t():t;return{load(){try{let i=localStorage.getItem(c);if(i!==null)return JSON.parse(i)}catch(i){console.warn(`iPIXEL: Could not load ${c}`,i)}return e()},save(i){try{localStorage.setItem(c,JSON.stringify(i))}catch(s){console.warn(`iPIXEL: Could not save ${c}`,s)}},clear(){try{localStorage.removeItem(c)}catch{}}}}function pe(){let c=[];typeof navigator<"u"&&!navigator.bluetooth&&c.push("WebBluetooth");try{document.createElement("canvas").getContext("2d")||c.push("Canvas")}catch{c.push("Canvas")}return c}var R=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this._config={},this._hass=null,this._handleTestModeChange=()=>this.render(),window.addEventListener("ipixel-test-mode-change",this._handleTestModeChange)}disconnectedCallback(){window.removeEventListener("ipixel-test-mode-change",this._handleTestModeChange)}set hass(t){this._hass=t,this.render()}setConfig(t){if(!t.entity&&!U()){this._config=t;return}this._config=t,this.render()}isInTestMode(){return U()||!this._config.entity||!this.getEntity()}getEntity(){return!this._hass||!this._config.entity?null:this._hass.states[this._config.entity]}getRelatedEntity(t,e=""){if(!this._hass||!this._config.entity)return null;let i=this._config.entity.replace(/^[^.]+\./,"").replace(/_?(text|display|gif_url)$/i,""),s=`${t}.${i}${e}`;if(this._hass.states[s])return this._hass.states[s];let o=Object.keys(this._hass.states).filter(n=>{if(!n.startsWith(`${t}.`))return!1;let r=n.replace(/^[^.]+\./,"");return r.includes(i)||i.includes(r.replace(e,""))});if(e){let n=o.find(r=>r.endsWith(e));if(n)return this._hass.states[n]}else{let n=o.sort((r,a)=>r.length-a.length);if(n.length>0)return this._hass.states[n[0]]}return o.length>0?this._hass.states[o[0]]:null}hasService(t,e){let i=this._hass?.services;return!i||!i[t]?!0:Object.prototype.hasOwnProperty.call(i[t],e)}async callService(t,e,i={}){if(this._hass){if(this.isInTestMode()&&console.info(`iPIXEL [Test Mode]: ${t}.${e}`,i),!this.hasService(t,e)){console.warn(`iPIXEL: ${t}.${e} is not provided by this version of the integration, so this control does nothing. Update the integration or remove the control.`);return}try{await this._hass.callService(t,e,i)}catch(s){console.error(`iPIXEL service call failed: ${t}.${e}`,s)}}}getResolution(){let t=this.getRelatedEntity("sensor","_width")||this._hass?.states["sensor.display_width"],e=this.getRelatedEntity("sensor","_height")||this._hass?.states["sensor.display_height"];if(t&&e){let i=parseInt(t.state),s=parseInt(e.state);if(!isNaN(i)&&!isNaN(s)&&i>0&&s>0)return[i,s]}return[64,16]}isOn(){return this.isInTestMode()?!0:this.getRelatedEntity("switch")?.state==="on"}hexToRgb(t){let e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t);return e?[parseInt(e[1],16),parseInt(e[2],16),parseInt(e[3],16)]:[255,255,255]}rgbToHex(t,e,i){return"#"+(t<<16|e<<8|i).toString(16).padStart(6,"0")}escapeHtml(t){let e=document.createElement("div");return e.textContent=t,e.innerHTML}render(){}getCardSize(){return 2}};var D=`
  :host {
...
`;function Mt(c){if(!c||c==="#111"||c==="#000")return[17,17,17];if(c==="#050505")return[5,5,5];let t=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(c);return t?[parseInt(t[1],16),parseInt(t[2],16),parseInt(t[3],16)]:[17,17,17]}function rt(c,t,e){let i=0,s=0,o=0,n=Math.floor(c*6),r=c*6-n,a=e*(1-t),l=e*(1-r*t),d=e*(1-(1-r)*t);switch(n%6){case 0:i=e,s=d,o=a;break;case 1:i=l,s=e,o=a;break;case 2:i=a,s=e,o=d;break;case 3:i=a,s=l,o=e;break;case 4:i=d,s=a,o=e;break;case 5:i=e,s=a,o=l;break}return[i*255,s*255,o*255]}var $t=class{constructor(t){this.renderer=t}init(t,e){let{width:i,height:s}=this.renderer;switch(t){case"scroll_ltr":case"scroll_rtl":e.offset=0;break;case"blink":e.visible=!0;break;case"snow":case"breeze":e.phases=[];for(let o=0;o<i*s;o++)e.phases.push(Math.random()*Math.PI*2);break;case"laser":e.position=0;break;case"fade":e.opacity=0,e.direction=1;break;case"typewriter":e.charIndex=0,e.cursorVisible=!0;break;case"bounce":e.offset=0,e.direction=1;break;case"sparkle":e.sparkles=[];for(let o=0;o<Math.floor(i*s*.1);o++)e.sparkles.push({x:Math.floor(Math.random()*i),y:Math.floor(Math.random()*s),brightness:Math.random(),speed:.05+Math.random()*.1});break}}step(t,e){let{width:i,extendedWidth:s}=this.renderer;switch(t){case"scroll_ltr":e.offset-=1,e.offset<=-(s||i)&&(e.offset=i);break;case"scroll_rtl":e.offset+=1,e.offset>=(s||i)&&(e.offset=-i);break;case"blink":e.visible=!e.visible;break;case"laser":e.position=(e.position+1)%i;break;case"fade":e.opacity+=e.direction*.05,e.opacity>=1?(e.opacity=1,e.direction=-1):e.opacity<=0&&(e.opacity=0,e.direction=1);break;case"typewriter":e.tick%3===0&&e.charIndex++,e.cursorVisible=e.tick%10<5;break;case"bounce":{e.offset+=e.direction;let o=Math.max(0,(s||i)-i);e.offset>=o?(e.offset=o,e.direction=-1):e.offset<=0&&(e.offset=0,e.direction=1);break}case"sparkle":{let o=e.sparkles;for(let n of o)n.brightness+=n.speed,n.brightness>1&&(n.brightness=0,n.x=Math.floor(Math.random()*i),n.y=Math.floor(Math.random()*this.renderer.height));break}}}render(t,e,i,s,o){let{width:n,height:r}=this.renderer,a=s||i||[],l=i||[],d=o||n;for(let h=0;h<r;h++)for(let f=0;f<n;f++){let p,u=f;if(t==="scroll_ltr"||t==="scroll_rtl"||t==="bounce"){for(u=f-(e.offset||0);u<0;)u+=d;for(;u>=d;)u-=d;p=a[h*d+u]||"#111"}else if(t==="typewriter"){let v=(e.charIndex||0)*6;f<v?p=l[h*n+f]||"#111":f===v&&e.cursorVisible?p="#ffffff":p="#111"}else p=l[h*n+f]||"#111";let[g,b,m]=Mt(p);if(g>20||b>20||m>20)switch(t){case"blink":e.visible||(g=b=m=17);break;case"snow":{let _=e.phases,v=_?.[h*n+f]||0,y=e.tick||0,k=.3+.7*Math.abs(Math.sin(v+y*.3));g*=k,b*=k,m*=k;break}case"breeze":{let _=e.phases,v=_?.[h*n+f]||0,y=e.tick||0,k=.4+.6*Math.abs(Math.sin(v+y*.15+f*.2));g*=k,b*=k,m*=k;break}case"laser":{let _=e.position||0,y=Math.abs(f-_)<3?1:.3;g*=y,b*=y,m*=y;break}case"fade":{let _=e.opacity||1;g*=_,b*=_,m*=_;break}}if(t==="sparkle"&&e.sparkles){let _=e.sparkles;for(let v of _)if(v.x===f&&v.y===h){let y=Math.sin(v.brightness*Math.PI);g=Math.min(255,g+y*200),b=Math.min(255,b+y*200),m=Math.min(255,m+y*200)}}this.renderer.setPixel(f,h,[g,b,m])}}},Rt=class{constructor(t){this.renderer=t}init(t,e){let{width:i,height:s}=this.renderer;switch(t){case"rainbow":e.position=0;break;case"matrix":{let o=[[0,255,0],[0,255,255],[255,0,255]];e.colorMode=o[Math.floor(Math.random()*o.length)],e.buffer=[];for(let n=0;n<s;n++)e.buffer.push(Array(i).fill(null).map(()=>[0,0,0]));break}case"plasma":case"gradient":e.time=0;break;case"fire":e.heat=[];for(let o=0;o<i*s;o++)e.heat.push(0);e.palette=this._createFirePalette();break;case"water":e.current=[],e.previous=[];for(let o=0;o<i*s;o++)e.current.push(0),e.previous.push(0);e.damping=.95;break;case"stars":{e.stars=[];let o=Math.floor(i*s*.15);for(let n=0;n<o;n++)e.stars.push({x:Math.floor(Math.random()*i),y:Math.floor(Math.random()*s),brightness:Math.random(),speed:.02+Math.random()*.05,phase:Math.random()*Math.PI*2});break}case"confetti":e.particles=[];for(let o=0;o<20;o++)e.particles.push(this._createConfettiParticle(i,s,!0));break;case"plasma_wave":case"radial_pulse":case"hypnotic":case"aurora":e.time=0;break;case"lava":e.time=0,e.noise=[];for(let o=0;o<i*s;o++)e.noise.push(Math.random()*Math.PI*2);break}}step(t,e){let{width:i,height:s}=this.renderer;switch(t){case"rainbow":e.position=(e.position+.01)%1;break;case"matrix":this._stepMatrix(e,i,s);break;case"plasma":case"gradient":e.time=(e.time||0)+.05;break;case"fire":this._stepFire(e,i,s);break;case"water":this._stepWater(e,i,s);break;case"stars":{let o=e.stars;for(let n of o)n.phase+=n.speed;break}case"confetti":{let o=e.particles;for(let n=0;n<o.length;n++){let r=o[n];r.y+=r.speed,r.x+=r.drift,r.rotation+=r.rotationSpeed,r.y>s&&(o[n]=this._createConfettiParticle(i,s,!1))}break}case"plasma_wave":case"radial_pulse":case"hypnotic":case"lava":case"aurora":e.time=(e.time||0)+.03;break}}render(t,e){switch(t){case"rainbow":this._renderRainbow(e);break;case"matrix":this._renderMatrix(e);break;case"plasma":this._renderPlasma(e);break;case"gradient":this._renderGradient(e);break;case"fire":this._renderFire(e);break;case"water":this._renderWater(e);break;case"stars":this._renderStars(e);break;case"confetti":this._renderConfetti(e);break;case"plasma_wave":this._renderPlasmaWave(e);break;case"radial_pulse":this._renderRadialPulse(e);break;case"hypnotic":this._renderHypnotic(e);break;case"lava":this._renderLava(e);break;case"aurora":this._renderAurora(e);break}}_renderRainbow(t){let{width:e,height:i}=this.renderer,s=t.position||0;for(let o=0;o<e;o++){let n=(s+o/e)%1,[r,a,l]=rt(n,1,.6);for(let d=0;d<i;d++)this.renderer.setPixel(o,d,[r,a,l])}}_stepMatrix(t,e,i){let s=t.buffer,o=t.colorMode,n=.15;s.pop();let r=s[0].map(([a,l,d])=>[a*(1-n),l*(1-n),d*(1-n)]);s.unshift(JSON.parse(JSON.stringify(r)));for(let a=0;a<e;a++)Math.random()<.08&&(s[0][a]=[Math.floor(Math.random()*o[0]),Math.floor(Math.random()*o[1]),Math.floor(Math.random()*o[2])])}_renderMatrix(t){var e;let{width:i,height:s}=this.renderer,o=t.buffer;if(o)for(let n=0;n<s;n++)for(let r=0;r<i;r++){let[a,l,d]=((e=o[n])==null?void 0:e[r])||[0,0,0];this.renderer.setPixel(r,n,[a,l,d])}}_renderPlasma(t){let{width:e,height:i}=this.renderer,s=t.time||0,o=e/2,n=i/2;for(let r=0;r<e;r++)for(let a=0;a<i;a++){let l=r-o,d=a-n,h=Math.sqrt(l*l+d*d),f=Math.sin(r/8+s),p=Math.sin(a/6+s*.8),u=Math.sin(h/6-s*1.2),g=Math.sin((r+a)/10+s*.5),b=(f+p+u+g+4)/8,m=Math.sin(b*Math.PI*2)*.5+.5,x=Math.sin(b*Math.PI*2+2)*.5+.5,_=Math.sin(b*Math.PI*2+4)*.5+.5;this.renderer.setPixel(r,a,[m*255,x*255,_*255])}}_renderGradient(t){let{width:e,height:i}=this.renderer,o=(t.time||0)*10;for(let n=0;n<e;n++)for(let r=0;r<i;r++){let a=(Math.sin((n+o)*.05)*.5+.5)*255,l=(Math.cos((r+o)*.05)*.5+.5)*255,d=(Math.sin((n+r+o)*.03)*.5+.5)*255;this.renderer.setPixel(n,r,[a,l,d])}}_createFirePalette(){let t=[];for(let e=0;e<256;e++){let i,s,o;e<64?(i=e*4,s=0,o=0):e<128?(i=255,s=(e-64)*4,o=0):e<192?(i=255,s=255,o=(e-128)*4):(i=255,s=255,o=255),t.push([i,s,o])}return t}_stepFire(t,e,i){let s=t.heat;for(let o=0;o<e*i;o++)s[o]=Math.max(0,s[o]-Math.random()*10);for(let o=0;o<i-1;o++)for(let n=0;n<e;n++){let r=o*e+n,a=(o+1)*e+n,l=o*e+Math.max(0,n-1),d=o*e+Math.min(e-1,n+1);s[r]=(s[a]+s[l]+s[d])/3.05}for(let o=0;o<e;o++)Math.random()<.6&&(s[(i-1)*e+o]=180+Math.random()*75)}_renderFire(t){let{width:e,height:i}=this.renderer,s=t.heat,o=t.palette;for(let n=0;n<i;n++)for(let r=0;r<e;r++){let a=n*e+r,l=Math.floor(Math.min(255,s[a])),[d,h,f]=o[l];this.renderer.setPixel(r,n,[d,h,f])}}_stepWater(t,e,i){let s=t.current,o=t.previous,n=t.damping,r=[...o];for(let a=0;a<s.length;a++)o[a]=s[a];for(let a=1;a<i-1;a++)for(let l=1;l<e-1;l++){let d=a*e+l;s[d]=(r[(a-1)*e+l]+r[(a+1)*e+l]+r[a*e+(l-1)]+r[a*e+(l+1)])/2-s[d],s[d]*=n}if(Math.random()<.1){let a=Math.floor(Math.random()*(e-2))+1,l=Math.floor(Math.random()*(i-2))+1;s[l*e+a]=255}}_renderWater(t){let{width:e,height:i}=this.renderer,s=t.current;for(let o=0;o<i;o++)for(let n=0;n<e;n++){let r=o*e+n,a=Math.abs(s[r]),l=Math.min(255,a*2),d=l>200?l:0,h=l>150?l*.8:l*.3,f=Math.min(255,50+l);this.renderer.setPixel(n,o,[d,h,f])}}_renderStars(t){let{width:e,height:i}=this.renderer;for(let o=0;o<i;o++)for(let n=0;n<e;n++)this.renderer.setPixel(n,o,[5,5,15]);let s=t.stars;for(let o of s){let n=(Math.sin(o.phase)*.5+.5)*255,r=Math.floor(o.x),a=Math.floor(o.y);r>=0&&r<e&&a>=0&&a<i&&this.renderer.setPixel(r,a,[n,n,n*.9])}}_createConfettiParticle(t,e,i){let s=[[255,0,0],[0,255,0],[0,0,255],[255,255,0],[255,0,255],[0,255,255],[255,128,0],[255,192,203]];return{x:Math.random()*t,y:i?Math.random()*e:-2,speed:.2+Math.random()*.3,drift:(Math.random()-.5)*.3,color:s[Math.floor(Math.random()*s.length)],size:1+Math.random(),rotation:Math.random()*Math.PI*2,rotationSpeed:(Math.random()-.5)*.2}}_renderConfetti(t){let{width:e,height:i}=this.renderer;for(let o=0;o<i;o++)for(let n=0;n<e;n++)this.renderer.setPixel(n,o,[10,10,10]);let s=t.particles;for(let o of s){let n=Math.floor(o.x),r=Math.floor(o.y);if(n>=0&&n<e&&r>=0&&r<i){let a=Math.abs(Math.sin(o.rotation))*.5+.5,[l,d,h]=o.color;this.renderer.setPixel(n,r,[l*a,d*a,h*a])}}}_renderPlasmaWave(t){let{width:e,height:i}=this.renderer,s=t.time||0;for(let o=0;o<e;o++)for(let n=0;n<i;n++){let r=o/e,a=n/i,l=Math.sin(r*10+s)+Math.sin(a*10+s)+Math.sin((r+a)*10+s)+Math.sin(Math.sqrt((r-.5)**2+(a-.5)**2)*20-s*2),d=Math.sin(l*Math.PI)*.5+.5,h=Math.sin(l*Math.PI+2.094)*.5+.5,f=Math.sin(l*Math.PI+4.188)*.5+.5;this.renderer.setPixel(o,n,[d*255,h*255,f*255])}}_renderRadialPulse(t){let{width:e,height:i}=this.renderer,s=t.time||0,o=e/2,n=i/2;for(let r=0;r<e;r++)for(let a=0;a<i;a++){let l=r-o,d=a-n,h=Math.sqrt(l*l+d*d),f=Math.sin(h*.8-s*3)*.5+.5,p=Math.sin(s*2)*.3+.7,u=(h/20+s*.5)%1,[g,b,m]=rt(u,.8,f*p);this.renderer.setPixel(r,a,[g,b,m])}}_renderHypnotic(t){let{width:e,height:i}=this.renderer,s=t.time||0,o=e/2,n=i/2;for(let r=0;r<e;r++)for(let a=0;a<i;a++){let l=r-o,d=a-n,h=Math.sqrt(l*l+d*d),f=Math.atan2(d,l),u=Math.sin(f*4+h*.5-s*2)*.5+.5,g=u*(Math.sin(s)*.5+.5),b=u*(Math.sin(s+2.094)*.5+.5),m=u*(Math.sin(s+4.188)*.5+.5);this.renderer.setPixel(r,a,[g*255,b*255,m*255])}}_renderLava(t){let{width:e,height:i}=this.renderer,s=t.time||0;for(let o=0;o<e;o++)for(let n=0;n<i;n++){let r=o/e,a=n/i,l=Math.sin(r*8+s*.7)*Math.cos(a*6+s*.5),d=Math.sin(r*12-s*.3)*Math.sin(a*10+s*.8),h=Math.cos((r+a)*5+s),f=(l+d+h+3)/6,p,u,g;f<.3?(p=f*3*100,u=0,g=0):f<.6?(p=100+(f-.3)*3*155,u=(f-.3)*3*100,g=0):(p=255,u=100+(f-.6)*2.5*155,g=(f-.6)*2.5*100),this.renderer.setPixel(o,n,[p,u,g])}}_renderAurora(t){let{width:e,height:i}=this.renderer,s=t.time||0;for(let o=0;o<e;o++)for(let n=0;n<i;n++){let r=o/e,a=n/i,l=Math.sin(r*6+s)*.3,d=Math.sin(r*4-s*.7)*.2,h=Math.sin(r*8+s*1.3)*.15,f=.5+l+d+h,p=Math.abs(a-f),u=Math.max(0,1-p*4),g=Math.pow(u,1.5),b=Math.sin(r*3+s*.5),m=g*(.2+b*.3)*255,x=g*(.8+Math.sin(s+r)*.2)*255,_=g*(.6+b*.4)*255,v=Math.sin(o*127.1+n*311.7)*.5+.5,y=Math.sin(s*3+o+n)*.5+.5;if(v>.98&&u<.3){let k=y*180;m=Math.max(m,k),x=Math.max(x,k),_=Math.max(_,k*.9)}this.renderer.setPixel(o,n,[m,x,_])}}},Lt=class{constructor(t){this.renderer=t}init(t,e){switch(t){case"color_cycle":e.hue=0;break;case"rainbow_text":e.offset=0;break;case"neon":e.glowIntensity=0,e.direction=1,e.baseColor=e.fgColor||"#ff00ff";break}}step(t,e){switch(t){case"color_cycle":e.hue=(e.hue+.01)%1;break;case"rainbow_text":e.offset=(e.offset+.02)%1;break;case"neon":e.glowIntensity+=e.direction*.05,e.glowIntensity>=1?(e.glowIntensity=1,e.direction=-1):e.glowIntensity<=.3&&(e.glowIntensity=.3,e.direction=1);break}}render(t,e,i){let{width:s,height:o}=this.renderer,n=i||[];for(let r=0;r<o;r++)for(let a=0;a<s;a++){let l=n[r*s+a]||"#111",[d,h,f]=Mt(l);if(d>20||h>20||f>20)switch(t){case"color_cycle":{let[u,g,b]=rt(e.hue,1,.8),m=(d+h+f)/(3*255);d=u*m,h=g*m,f=b*m;break}case"rainbow_text":{let u=(e.offset+a/s)%1,[g,b,m]=rt(u,1,.8),x=(d+h+f)/(3*255);d=g*x,h=b*x,f=m*x;break}case"neon":{let u=Mt(e.baseColor||"#ff00ff"),g=e.glowIntensity||.5;if(d=u[0]*g,h=u[1]*g,f=u[2]*g,g>.8){let b=(g-.8)*5;d=d+(255-d)*b*.3,h=h+(255-h)*b*.3,f=f+(255-f)*b*.3}break}}this.renderer.setPixel(a,r,[d,h,f])}}},z={TEXT:"text",AMBIENT:"ambient",COLOR:"color"},$={fixed:{category:"text",name:"Fixed",description:"Static display"},scroll_ltr:{category:"text",name:"Scroll Left",description:"Text scrolls left to right"},scroll_rtl:{category:"text",name:"Scroll Right",description:"Text scrolls right to left"},blink:{category:"text",name:"Blink",description:"Text blinks on/off"},breeze:{category:"text",name:"Breeze",description:"Gentle wave brightness"},snow:{category:"text",name:"Snow",description:"Sparkle effect"},laser:{category:"text",name:"Laser",description:"Scanning beam"},fade:{category:"text",name:"Fade",description:"Fade in/out"},typewriter:{category:"text",name:"Typewriter",description:"Characters appear one by one"},bounce:{category:"text",name:"Bounce",description:"Text bounces back and forth"},sparkle:{category:"text",name:"Sparkle",description:"Random sparkle overlay"},rainbow:{category:"ambient",name:"Rainbow",description:"HSV rainbow gradient"},matrix:{category:"ambient",name:"Matrix",description:"Digital rain effect"},plasma:{category:"ambient",name:"Plasma",description:"Classic plasma waves"},gradient:{category:"ambient",name:"Gradient",description:"Moving color gradients"},fire:{category:"ambient",name:"Fire",description:"Fire/flame simulation"},water:{category:"ambient",name:"Water",description:"Ripple/wave effect"},stars:{category:"ambient",name:"Stars",description:"Twinkling starfield"},confetti:{category:"ambient",name:"Confetti",description:"Falling colored particles"},plasma_wave:{category:"ambient",name:"Plasma Wave",description:"Multi-frequency sine waves"},radial_pulse:{category:"ambient",name:"Radial Pulse",description:"Expanding ring patterns"},hypnotic:{category:"ambient",name:"Hypnotic",description:"Spiral pattern"},lava:{category:"ambient",name:"Lava",description:"Flowing lava/magma"},aurora:{category:"ambient",name:"Aurora",description:"Northern lights"},color_cycle:{category:"color",name:"Color Cycle",description:"Cycle through colors"},rainbow_text:{category:"color",name:"Rainbow Text",description:"Rainbow gradient on text"},neon:{category:"color",name:"Neon",description:"Pulsing neon glow"}},lt=class{constructor(t){this.renderer=t,this.textEffects=new $t(t),this.ambientEffects=new Rt(t),this.colorEffects=new Lt(t),this.currentEffect="fixed",this.effectState={tick:0}}getEffectInfo(t){return $[t]||$.fixed}getEffectsByCategory(t){return Object.entries($).filter(([,e])=>e.category===t).map(([e,i])=>({key:e,...i}))}initEffect(t,e={}){let i=this.getEffectInfo(t);switch(this.currentEffect=t,this.effectState={tick:0,...e},i.category){case"text":this.textEffects.init(t,this.effectState);break;case"ambient":this.ambientEffects.init(t,this.effectState);break;case"color":this.colorEffects.init(t,this.effectState);break}return this.effectState}step(){let t=this.getEffectInfo(this.currentEffect);switch(this.effectState.tick=(this.effectState.tick||0)+1,t.category){case"text":this.textEffects.step(this.currentEffect,this.effectState);break;case"ambient":this.ambientEffects.step(this.currentEffect,this.effectState);break;case"color":this.colorEffects.step(this.currentEffect,this.effectState);break}}render(t,e,i){switch(this.getEffectInfo(this.currentEffect).category){case"ambient":this.ambientEffects.render(this.currentEffect,this.effectState);break;case"text":this.textEffects.render(this.currentEffect,this.effectState,t,e,i);break;case"color":this.colorEffects.render(this.currentEffect,this.effectState,t);break}}isAmbient(t){return this.getEffectInfo(t).category==="ambient"}needsAnimation(t){return t!=="fixed"}},qe=Object.entries($).filter(([,c])=>c.category==="text").map(([c])=>c),Ye=Object.entries($).filter(([,c])=>c.category==="ambient").map(([c])=>c),Je=Object.entries($).filter(([,c])=>c.category==="color").map(([c])=>c),Ke=Object.keys($),B=class{constructor(t,e={}){this.container=t,this.width=e.width||64,this.height=e.height||16,this.pixelGap=e.pixelGap||.15,this.glowEnabled=e.glow!==!1,this.scale=e.scale||8,this.buffer=[],this._initBuffer(),this._colorPixels=[],this._extendedColorPixels=[],this.extendedWidth=this.width,this.effect="fixed",this.speed=50,this.animationId=null,this.lastFrameTime=0,this._isRunning=!1,this._canvas=null,this._ctx=null,this._imageData=null,this._glowCanvas=null,this._glowCtx=null,this._wrapper=null,this._canvasCreated=!1,this._pixelTemplate=null,this.effectManager=new lt(this)}_initBuffer(){this.buffer=[];for(let t=0;t<this.width*this.height;t++)this.buffer.push([0,0,0])}_createCanvas(){if(typeof document>"u")return;let t=this.width*this.scale,e=this.height*this.scale;this._wrapper=document.createElement("div"),this._wrapper.style.cssText=`
    ...
    `,this._ctx=this._canvas.getContext("2d",{alpha:!1}),this._wrapper.appendChild(this._canvas),this._imageData=this._ctx.createImageData(t,e),this._createPixelTemplate(),this._fillBackground(),this.container&&this.container.isConnected!==!1&&(this.container.innerHTML="",this.container.appendChild(this._wrapper)),this._canvasCreated=!0}_createPixelTemplate(){let t=this.scale,e=Math.max(1,Math.floor(t*this.pixelGap)),i=t-e,s=Math.max(1,Math.floor(t*.15));this._pixelTemplate=[];for(let o=0;o<t;o++)for(let n=0;n<t;n++){let r=!1;if(n<i&&o<i)if(n<s&&o<s){let a=s-n,l=s-o;r=a*a+l*l<=s*s}else if(n>=i-s&&o<s){let a=n-(i-s-1),l=s-o;r=a*a+l*l<=s*s}else if(n<s&&o>=i-s){let a=s-n,l=o-(i-s-1);r=a*a+l*l<=s*s}else if(n>=i-s&&o>=i-s){let a=n-(i-s-1),l=o-(i-s-1);r=a*a+l*l<=s*s}else r=!0;this._pixelTemplate.push(r)}}_fillBackground(){if(!this._imageData)return;let t=this._imageData.data,e=10,i=10,s=10;for(let o=0;o<t.length;o+=4)t[o]=e,t[o+1]=i,t[o+2]=s,t[o+3]=255}_ensureCanvasInContainer(){return this.container?this._wrapper&&this._wrapper.parentNode===this.container?!0:this._wrapper&&this.container.isConnected!==!1?(this.container.innerHTML="",this.container.appendChild(this._wrapper),!0):!1:!1}setPixel(t,e,i){if(t>=0&&t<this.width&&e>=0&&e<this.height){let s=e*this.width+t;s<this.buffer.length&&(this.buffer[s]=i)}}clear(){for(let t=0;t<this.buffer.length;t++)this.buffer[t]=[0,0,0]}flush(){if(this._canvasCreated?this._ensureCanvasInContainer()||this._createCanvas():this._createCanvas(),!this._imageData||!this._ctx||!this._pixelTemplate)return;let t=this._imageData.data,e=this.scale,i=this.width*e,s=this._pixelTemplate,o=10,n=10,r=10;for(let a=0;a<this.height;a++)for(let l=0;l<this.width;l++){let d=a*this.width+l,h=this.buffer[d];if(!h||!Array.isArray(h))continue;let f=Math.round(h[0]),p=Math.round(h[1]),u=Math.round(h[2]),g=l*e,b=a*e;for(let m=0;m<e;m++)for(let x=0;x<e;x++){let _=m*e+x,v=((b+m)*i+(g+x))*4;s[_]?(t[v]=f,t[v+1]=p,t[v+2]=u,t[v+3]=255):(t[v]=o,t[v+1]=n,t[v+2]=r,t[v+3]=255)}}this._ctx.putImageData(this._imageData,0,0),this.glowEnabled&&this._glowCtx&&this._glowCtx.drawImage(this._canvas,0,0)}setData(t,e=null,i=null){this._colorPixels=t||[],e?(this._extendedColorPixels=e,this.extendedWidth=i||this.width):(this._extendedColorPixels=t||[],this.extendedWidth=this.width)}setEffect(t,e=50){let i=this._isRunning;this.effect!==t&&(this.effect=t,this.effectManager.initEffect(t,{speed:e})),this.speed=e,i&&t!=="fixed"&&this.start()}start(){this._isRunning||(this._isRunning=!0,this.lastFrameTime=performance.now(),this._animate())}stop(){this._isRunning=!1,this.animationId&&(cancelAnimationFrame(this.animationId),this.animationId=null)}get isRunning(){return this._isRunning}_animate(){if(!this._isRunning)return;let t=performance.now(),e=500-(this.speed-1)*4.7;t-this.lastFrameTime>=e&&(this.lastFrameTime=t,this.effectManager.step()),this._renderFrame(),this.animationId=requestAnimationFrame(()=>this._animate())}_renderFrame(){this.effectManager.render(this._colorPixels,this._extendedColorPixels,this.extendedWidth),this.flush()}renderStatic(){this._canvasCreated||this._createCanvas(),this._renderFrame()}setDimensions(t,e){(t!==this.width||e!==this.height)&&(this.width=t,this.height=e,this.extendedWidth=t,this._initBuffer(),this._canvasCreated=!1,this.effectManager=new lt(this),this.effect!=="fixed"&&this.effectManager.initEffect(this.effect,{speed:this.speed}))}setContainer(t){t!==this.container&&(this.container=t,this._wrapper&&t&&(t.innerHTML="",t.appendChild(this._wrapper)))}destroy(){this.stop(),this._canvas=null,this._ctx=null,this._imageData=null,this._glowCanvas=null,this._glowCtx=null,this._wrapper=null,this._canvasCreated=!1,this._pixelTemplate=null}};var ct={A:[124,18,17,18,124],B:[127,73,73,73,54],C:[62,65,65,65,34],D:[127,65,65,34,28],E:[127,73,73,73,65],F:[127,9,9,9,1],G:[62,65,73,73,122],H:[127,8,8,8,127],I:[0,65,127,65,0],J:[32,64,65,63,1],K:[127,8,20,34,65],L:[127,64,64,64,64],M:[127,2,12,2,127],N:[127,4,8,16,127],O:[62,65,65,65,62],P:[127,9,9,9,6],Q:[62,65,81,33,94],R:[127,9,25,41,70],S:[70,73,73,73,49],T:[1,1,127,1,1],U:[63,64,64,64,63],V:[31,32,64,32,31],W:[63,64,56,64,63],X:[99,20,8,20,99],Y:[7,8,112,8,7],Z:[97,81,73,69,67],a:[32,84,84,84,120],b:[127,72,68,68,56],c:[56,68,68,68,32],d:[56,68,68,72,127],e:[56,84,84,84,24],f:[8,126,9,1,2],g:[12,82,82,82,62],h:[127,8,4,4,120],i:[0,68,125,64,0],j:[32,64,68,61,0],k:[127,16,40,68,0],l:[0,65,127,64,0],m:[124,4,24,4,120],n:[124,8,4,4,120],o:[56,68,68,68,56],p:[124,20,20,20,8],q:[8,20,20,24,124],r:[124,8,4,4,8],s:[72,84,84,84,32],t:[4,63,68,64,32],u:[60,64,64,32,124],v:[28,32,64,32,28],w:[60,64,48,64,60],x:[68,40,16,40,68],y:[12,80,80,80,60],z:[68,100,84,76,68],0:[62,81,73,69,62],1:[0,66,127,64,0],2:[66,97,81,73,70],3:[33,65,69,75,49],4:[24,20,18,127,16],5:[39,69,69,69,57],6:[60,74,73,73,48],7:[1,113,9,5,3],8:[54,73,73,73,54],9:[6,73,73,41,30]," ":[0,0,0,0,0],".":[0,96,96,0,0],",":[0,128,96,0,0],":":[0,54,54,0,0],";":[0,128,54,0,0],"!":[0,0,95,0,0],"?":[2,1,81,9,6],"-":[8,8,8,8,8],"+":[8,8,62,8,8],"=":[20,20,20,20,20],_:[64,64,64,64,64],"/":[32,16,8,4,2],"\\":[2,4,8,16,32],"(":[0,28,34,65,0],")":[0,65,34,28,0],"[":[0,127,65,65,0],"]":[0,65,65,127,0],"<":[8,20,34,65,0],">":[0,65,34,20,8],"*":[20,8,62,8,20],"#":[20,127,20,127,20],"@":[62,65,93,85,30],"&":[54,73,85,34,80],"%":[35,19,8,100,98],$:[18,42,127,42,36],"'":[0,0,7,0,0],'"':[0,7,0,7,0],"`":[0,1,2,0,0],"^":[4,2,1,2,4],"~":[8,4,8,16,8]};function dt(c,t,e,i="#ff6600",s="#111"){let o=[],a=Math.floor((e-7)/2);for(let f=0;f<e;f++)for(let p=0;p<t;p++)o.push(s);let l=c.length*6-1,h=Math.max(1,Math.floor((t-l)/2));for(let f of c){let p=ct[f]||ct[" "];for(let u=0;u<5;u++)for(let g=0;g<7;g++){let b=p[u]>>g&1,m=h+u,x=a+g;m>=0&&m<t&&x<e&&x>=0&&(o[x*t+m]=b?i:s)}h+=6}return o}function ht(c,t,e,i="#ff6600",s="#111"){let r=Math.floor((e-7)/2),a=c.length*6,l=t+a+t,d=[];for(let f=0;f<e;f++)for(let p=0;p<l;p++)d.push(s);let h=t;for(let f of c){let p=ct[f]||ct[" "];for(let u=0;u<5;u++)for(let g=0;g<7;g++){let b=p[u]>>g&1,m=h+u,x=r+g;m>=0&&m<l&&x<e&&x>=0&&(d[x*l+m]=b?i:s)}h+=6}return{pixels:d,width:l}}var Jt={VCR_OSD_MONO:{16:{font_size:16,offset:[0,0],pixel_threshold:70,var_width:!0},24:{font_size:24,offset:[0,0],pixel_threshold:70,var_width:!0},32:{font_size:28,offset:[-1,2],pixel_threshold:30,var_width:!1}},CUSONG:{16:{font_size:16,offset:[0,-1],pixel_threshold:70,var_width:!1},24:{font_size:24,offset:[0,0],pixel_threshold:70,var_width:!1},32:{font_size:32,offset:[0,0],pixel_threshold:70,var_width:!1}}},at={},Tt={},Ze=c=>typeof window>"u"?`/fonts/${c}.ttf`:`${window.location.pathname.substring(0,window.location.pathname.lastIndexOf("/")+1)}fonts/${c}.ttf`,ve=Ze;function qt(c){ve=c}function J(c){return c<=18?16:c<=28?24:32}async function N(c,t){return at[c]===!0?!0:at[c]===!1?!1:(c in Tt||(Tt[c]=(async()=>{if(typeof document>"u")return!1;let i=(t||ve)(c);try{let o=await new FontFace(c,`url(${i})`).load();return document.fonts.add(o),at[c]=!0,!0}catch(s){return console.warn(`PixelDisplay: Failed to load font ${c}:`,s),at[c]=!1,!1}})()),Tt[c])}function K(c){return at[c]===!0}function ft(c,t,e,i="#ff6600",s="#111",o="VCR_OSD_MONO"){if(typeof document>"u")return null;let n=Jt[o];if(!n)return null;if(!K(o))return N(o),null;let r=J(e),a=n[r],l=document.createElement("canvas");l.width=t,l.height=e;let d=l.getContext("2d");if(!d)return null;if(d.imageSmoothingEnabled=!1,d.fillStyle=s,d.fillRect(0,0,t,e),!c||c.trim()===""){let m=[];for(let x=0;x<t*e;x++)m.push(s);return m}d.font=`${a.font_size}px "${o}"`,d.fillStyle=i,d.textBaseline="top";let f=d.measureText(c).width,p=Math.floor((t-f)/2)+a.offset[0],u=Math.floor((e-a.font_size)/2)+a.offset[1];d.fillText(c,p,u);let g=d.getImageData(0,0,t,e),b=[];for(let m=0;m<g.data.length;m+=4){let x=g.data[m],_=g.data[m+1],v=g.data[m+2],y=(x+_+v)/3;b.push(y>=a.pixel_threshold?i:s)}return b}function pt(c,t,e,i="#ff6600",s="#111",o="VCR_OSD_MONO"){if(typeof document>"u")return null;let n=Jt[o];if(!n)return null;if(!K(o))return N(o),null;let r=J(e),a=n[r],d=document.createElement("canvas").getContext("2d");if(!d)return null;d.font=`${a.font_size}px "${o}"`;let h=Math.ceil(d.measureText(c).width),f=t+h+t,p=document.createElement("canvas");p.width=f,p.height=e;let u=p.getContext("2d");if(!u)return null;if(u.imageSmoothingEnabled=!1,u.fillStyle=s,u.fillRect(0,0,f,e),!c||c.trim()===""){let _=[];for(let v=0;v<f*e;v++)_.push(s);return{pixels:_,width:f}}u.font=`${a.font_size}px "${o}"`,u.fillStyle=i,u.textBaseline="top";let g=t+a.offset[0],b=Math.floor((e-a.font_size)/2)+a.offset[1];u.fillText(c,g,b);let m=u.getImageData(0,0,f,e),x=[];for(let _=0;_<m.data.length;_+=4){let v=m.data[_],y=m.data[_+1],k=m.data[_+2],w=(v+y+k)/3;x.push(w>=a.pixel_threshold?i:s)}return{pixels:x,width:f}}var Ot=null,Pt=null;async function Qe(){if(Ot&&Pt)return!0;try{let c=await Promise.resolve().then(()=>(me(),ge)),t=await Promise.resolve().then(()=>(_e(),be));Ot=c.$Font;let e=t;return Pt=e.default||e.$fetchline||t,!0}catch{return console.warn("PixelDisplay: bdfparser/fetchline packages not available. BDF font rendering disabled."),!1}}var xe={VCR_OSD_MONO:{16:{file:"VCR_OSD_MONO_16.bdf",yOffset:0},24:{file:"VCR_OSD_MONO_24.bdf",yOffset:0},32:{file:"VCR_OSD_MONO_32.bdf",yOffset:2}},CUSONG:{16:{file:"CUSONG_16.bdf",yOffset:-1},24:{file:"CUSONG_24.bdf",yOffset:0},32:{file:"CUSONG_32.bdf",yOffset:0}}},et=new Map,kt=new Map,ti=(c,t)=>typeof window>"u"?`/fonts/${t||c}`:`${window.location.pathname.substring(0,window.location.pathname.lastIndexOf("/")+1)}fonts/${t||c}`,ye=ti;function Yt(c){ye=c}function we(c){return c<=18?16:c<=28?24:32}async function P(c,t=16,e){let i=`${c}_${t}`;if(et.has(i))return et.get(i);if(kt.has(i))return kt.get(i);let s=xe[c];if(!s||!s[t])return console.warn(`PixelDisplay BDF: No config for font ${c} at height ${t}`),null;let o=s[t],n=(async()=>{try{if(!await Qe()||!Ot||!Pt)return null;let l=(e||ye)(c,o.file),h={font:await Ot(Pt(l)),config:o};return et.set(i,h),h}catch(r){return console.warn(`PixelDisplay BDF: Failed to load font ${c} (${t}px):`,r),kt.delete(i),null}})();return kt.set(i,n),n}function ut(c,t=16){let e=`${c}_${t}`;return et.has(e)}function gt(c,t,e,i="#ff6600",s="#111",o="VCR_OSD_MONO"){let n=we(e),r=`${o}_${n}`,a=et.get(r);if(!a)return P(o,n),null;let{font:l,config:d}=a,h=new Array(t*e).fill(s);if(!c||c.trim()==="")return h;try{let f=l.draw(c,{direction:"lrtb",mode:1}),p=f.bindata,u=f.width(),g=f.height(),b=Math.floor((t-u)/2),m=Math.floor((e-g)/2)+(d.yOffset||0);for(let x=0;x<g;x++){let _=p[x]||"";for(let v=0;v<_.length;v++){let y=b+v,k=m+x;if(y>=0&&y<t&&k>=0&&k<e){let w=k*t+y;h[w]=_[v]==="1"?i:s}}}}catch(f){return console.warn("PixelDisplay BDF: Error rendering text:",f),null}return h}function mt(c,t,e,i="#ff6600",s="#111",o="VCR_OSD_MONO"){let n=we(e),r=`${o}_${n}`,a=et.get(r);if(!a)return P(o,n),null;let{font:l,config:d}=a;if(!c||c.trim()===""){let h=t*3;return{pixels:new Array(h*e).fill(s),width:h}}try{let h=l.draw(c,{direction:"lrtb",mode:1}),f=h.bindata,p=h.width(),u=h.height(),g=t+p+t,b=new Array(g*e).fill(s),m=t,x=Math.floor((e-u)/2)+(d.yOffset||0);for(let _=0;_<u;_++){let v=f[_]||"";for(let y=0;y<v.length;y++){let k=m+y,w=x+_;if(k>=0&&k<g&&w>=0&&w<e){let C=w*g+k;b[C]=v[y]==="1"?i:s}}}return{pixels:b,width:g}}catch(h){return console.warn("PixelDisplay BDF: Error rendering scroll text:",h),null}}function Z(c){if(c.baseUrl){let t=c.baseUrl.replace(/\/+$/,"");qt(e=>`${t}/${e}.ttf`),Yt((e,i)=>`${t}/${i||e}`)}c.ttfResolver&&qt(c.ttfResolver),c.bdfResolver&&Yt(c.bdfResolver)}var ei=typeof window<"u"&&(typeof window.hassConnection<"u"||document.querySelector("home-assistant")!==null);if(ei)Z({ttfResolver:c=>`/hacsfiles/ipixel_color/fonts/${c}.ttf`,bdfResolver:(c,t)=>`/hacsfiles/ipixel_color/fonts/${t||c}`});else if(typeof window<"u"){let c=window.location.pathname.substring(0,window.location.pathname.lastIndexOf("/")+1);Z({baseUrl:`${c}fonts`})}var At=new Map,Dt=class extends R{constructor(){super(),this._renderer=null,this._displayContainer=null,this._lastState=null,this._cachedResolution=null,this._rendererId=null,this._handleDisplayUpdate=t=>{this._updateDisplay(t.detail)},window.addEventListener("ipixel-display-update",this._handleDisplayUpdate)}connectedCallback(){this._rendererId||(this._rendererId=`renderer_${Date.now()}_${Math.random().toString(36).substr(2,9)}`),At.has(this._rendererId)&&(this._renderer=At.get(this._rendererId)),P("VCR_OSD_MONO",16).then(()=>{this._lastState&&this._updateDisplay(this._lastState)}),P("VCR_OSD_MONO",24),P("VCR_OSD_MONO",32),P("CUSONG",16),P("CUSONG",24),P("CUSONG",32),N("VCR_OSD_MONO"),N("CUSONG")}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("ipixel-display-update",this._handleDisplayUpdate),this._renderer&&this._rendererId&&(this._renderer.stop(),At.set(this._rendererId,this._renderer))}_getResolutionCached(){let[t,e]=this.getResolution();if(t>0&&e>0){this._cachedResolution=[t,e];try{localStorage.setItem("iPIXEL_Resolution",JSON.stringify([t,e]))}catch{}return this._cachedResolution}try{let i=localStorage.getItem("iPIXEL_Resolution");if(i){let s=JSON.parse(i);if(Array.isArray(s)&&s.length===2&&s[0]>0&&s[1]>0)return this._cachedResolution=s,s}}catch{}return this._cachedResolution?this._cachedResolution:this._config?.width&&this._config?.height?[this._config.width,this._config.height]:[t||64,e||16]}_updateDisplay(t){if(!this._displayContainer)return;let[e,i]=this._getResolutionCached(),s=this.isOn();if(this._renderer?(this._renderer.setContainer(this._displayContainer),(this._renderer.width!==e||this._renderer.height!==i)&&this._renderer.setDimensions(e,i)):(this._renderer=new B(this._displayContainer,{width:e,height:i}),this._rendererId&&At.set(this._rendererId,this._renderer)),!s){this._renderer.setData([]),this._renderer.setEffect("fixed",50),this._renderer.stop(),this._renderer.renderStatic();return}let o=t?.text||"",n=t?.effect||"fixed",r=t?.speed||50,a=t?.fgColor||"#ff6600",l=t?.bgColor||"#111",d=t?.mode||"text",h=t?.font||"VCR_OSD_MONO";this._lastState=t;let f=o,p=a;if(d==="clock"?(f=new Date().toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!1}),p="#00ff88"):d==="gif"?(f="GIF",p="#ff44ff"):d==="rhythm"&&(f="***",p="#44aaff"),$[n]?.category==="ambient")this._renderer.setData([],[],e);else{let b=J(i),m=h!=="LEGACY"&&ut(h,b),x=h!=="LEGACY"&&K(h),_=(w,C,S,T,I)=>{if(m){let M=gt(w,C,S,T,I,h);if(M)return M}if(x){let M=ft(w,C,S,T,I,h);if(M)return M}return dt(w,C,S,T,I)},v=(w,C,S,T,I)=>{if(m){let M=mt(w,C,S,T,I,h);if(M)return M}if(x){let M=pt(w,C,S,T,I,h);if(M)return M}return ht(w,C,S,T,I)},y=x?f.length*10:f.length*6;if((n==="scroll_ltr"||n==="scroll_rtl"||n==="bounce")&&y>e){let w=v(f,e,i,p,l),C=_(f,e,i,p,l);this._renderer.setData(C,w.pixels,w.width)}else{let w=_(f,e,i,p,l);this._renderer.setData(w)}}this._renderer.setEffect(n,r),n==="fixed"?(this._renderer.stop(),this._renderer.renderStatic()):this._renderer.start()}_getTestModeState(){let t=[{text:"iPIXEL",effect:"scroll_ltr",speed:40,fgColor:"#ff6600",bgColor:"#000000",mode:"text",font:"VCR_OSD_MONO"},{text:"Hello!",effect:"rainbow_cycle",speed:50,fgColor:"#00ff88",bgColor:"#000000",mode:"text",font:"VCR_OSD_MONO"},{text:"TEST",effect:"fixed",speed:50,fgColor:"#03a9f4",bgColor:"#111111",mode:"text",font:"VCR_OSD_MONO"},{text:"",effect:"rainbow",speed:60,fgColor:"#ffffff",bgColor:"#000000",mode:"ambient",font:"VCR_OSD_MONO"}],e=Math.floor(Date.now()/1e4)%t.length;return t[e]}render(){let t=this.isInTestMode();if(!this._hass&&!t)return;let[e,i]=this._getResolutionCached(),s=this.isOn(),o=this._config.name||this.getEntity()?.attributes?.friendly_name||"iPIXEL Display",n=F(),a=this.getEntity()?.state||"",d=this.getRelatedEntity("select","_mode")?.state||n.mode||"text",h=n.text||a||(t?"iPIXEL":""),f=n.effect||"fixed",p=n.speed||50,u=n.fgColor||"#ff6600",g=n.bgColor||"#111",b=n.font||"VCR_OSD_MONO",x=$[f]?.category==="ambient",_=pe(),v=U(),y="";if(t){let T=_.length>0?`<div class="test-mode-features">Missing: ${_.join(", ")}</div>`:"";y=`
        ...
        </div>`;let k=Object.entries($).filter(([T,I])=>I.category==="text").map(([T,I])=>`<option value="${T}">${I.name}</option>`).join(""),w=Object.entries($).filter(([T,I])=>I.category==="ambient").map(([T,I])=>`<option value="${T}">${I.name}</option>`).join(""),C=Object.entries($).filter(([T,I])=>I.category==="color").map(([T,I])=>`<option value="${T}">${I.name}</option>`).join("");this.shadowRoot.innerHTML=`
      <style>${D}
      ...
      </ha-card>`,this._displayContainer=this.shadowRoot.getElementById("display-screen");let S=t&&!n.text&&n.effect==="fixed"?this._getTestModeState():{text:h,effect:f,speed:p,fgColor:u,bgColor:g,mode:d,font:b};this._updateDisplay(S),this._attachPowerButton(),this._attachTestModeListeners()}_attachPowerButton(){this.shadowRoot.getElementById("power-btn")?.addEventListener("click",()=>{if(this.isInTestMode()){this._testPowerState=!this._testPowerState,this.render();return}let t=this._switchEntityId;if(!t){let e=this.getRelatedEntity("switch");e&&(this._switchEntityId=e.entity_id,t=e.entity_id)}if(t&&this._hass?.states[t])this._hass.callService("switch","toggle",{entity_id:t});else{let e=Object.keys(this._hass?.states||{}).filter(o=>o.startsWith("switch.")),i=this._config.entity?.replace(/^[^.]+\./,"").replace(/_?(text|display|gif_url)$/i,"")||"",s=e.find(o=>o.includes(i.substring(0,10)));s?(this._switchEntityId=s,this._hass.callService("switch","toggle",{entity_id:s})):console.warn("iPIXEL: No switch found. Entity:",this._config.entity,"Available:",e)}})}_attachTestModeListeners(){this.shadowRoot.getElementById("test-mode-toggle")?.addEventListener("click",()=>{Et(!U())}),this.shadowRoot.querySelectorAll("[data-demo]").forEach(t=>{t.addEventListener("click",e=>{let i=e.currentTarget.dataset.demo,o={text:{text:"iPIXEL",effect:"fixed",speed:50,fgColor:"#ff6600",bgColor:"#000000",mode:"text",font:"VCR_OSD_MONO"},scroll:{text:"Hello World!",effect:"scroll_ltr",speed:40,fgColor:"#00ff88",bgColor:"#000000",mode:"text",font:"VCR_OSD_MONO"},rainbow:{text:"",effect:"rainbow",speed:60,fgColor:"#ffffff",bgColor:"#000000",mode:"ambient",font:"VCR_OSD_MONO"},clock:{text:"",effect:"fixed",speed:50,fgColor:"#00ff88",bgColor:"#000000",mode:"clock",font:"VCR_OSD_MONO"},fire:{text:"",effect:"fire",speed:50,fgColor:"#ffffff",bgColor:"#000000",mode:"ambient",font:"VCR_OSD_MONO"},stars:{text:"",effect:"stars",speed:40,fgColor:"#ffffff",bgColor:"#000000",mode:"ambient",font:"VCR_OSD_MONO"}}[i];o&&(E(o),this.shadowRoot.querySelectorAll("[data-demo]").forEach(n=>n.classList.remove("active")),e.currentTarget.classList.add("active"))})})}static getConfigElement(){return document.createElement("ipixel-simple-editor")}static getStubConfig(){return{entity:""}}};function it({id:c,min:t=0,max:e=100,value:i=50,unit:s="",showValue:o=!0,valueFormatter:n}){let r=(i-t)/(e-t)*100,a=n?n(i):`${i}${s}`;return`
    <div class="slider-row">
      <input type="range" class="slider" id="${c}" min="${t}" max="${e}" value="${i}" style="--value:${r}%">
      ${o?`<span class="slider-value" id="${c}-val">${a}</span>`:""}
    </div>`}function st(c,t,{onInput:e,onChange:i,unit:s="",valueFormatter:o}={}){let n=c.getElementById(t);if(!n)return;let r=c.getElementById(`${t}-val`),a=Number(n.min),l=Number(n.max),d=h=>{let f=Number(h),p=l>a?(f-a)/(l-a)*100:0;return n.style.setProperty("--value",`${p}%`),r&&(r.textContent=o?o(f):`${f}${s}`),f};d(n.value),n.addEventListener("input",h=>{let f=d(h.target.value);e?.(f,h)}),i&&n.addEventListener("change",h=>i(Number(h.target.value),h))}function L(c,{selected:t,itemClass:e="mode-btn",gridClass:i="button-grid button-grid-3",dataAttr:s="value",label:o=l=>l.name,value:n=l=>l.value,extraClass:r=()=>"",title:a}={}){let l=Array.isArray(t)?h=>t.some(f=>String(f)===String(h)):h=>String(h)===String(t),d=c.map(h=>{let f=n(h),p=l(f)?" active":"",u=r(h),g=u?` ${u}`:"",b=a?` title="${a(h)}"`:"";return`<button class="${e}${p}${g}" data-${s}="${f}"${b}>${o(h)}</button>`}).join("");return`<div class="${i}">${d}</div>`}function A(c,t,{onSelect:e,multi:i=!1,attr:s="value"}={}){c.querySelectorAll(t).forEach(o=>{o.addEventListener("click",n=>{let r=n.currentTarget,a=r.dataset[s];if(i){let l=r.classList.toggle("active");e?.(a,l,r)}else c.querySelectorAll(t).forEach(l=>l.classList.remove("active")),r.classList.add("active"),e?.(a,r)})})}function Kt(c){return`<div class="color-row">${c.map((e,i)=>`<span class="color-row-label"${i>0?' style="margin-left:16px;"':""}>${e.label}:</span>
      <input type="color" class="color-picker" id="${e.id}" value="${e.value}">`).join("")}</div>`}function Zt(c,t,e){t.forEach(i=>{c.getElementById(i)?.addEventListener("input",s=>e?.(i,s.target.value,s))})}function V({id:c,active:t=!1,label:e,labelRight:i=!1,padding:s}={}){let o=e?`<span class="toggle-label">${e}</span>`:"";return`
    <div class="toggle-row"${s?` style="padding:${s};"`:""}>
      ${i?"":o}
      <div class="toggle-switch${t?" active":""}" id="${c}"></div>
      ${i?o:""}
    </div>`}function G(c,t,e){let i=c.getElementById(t);i&&i.addEventListener("click",s=>{let o=!s.currentTarget.classList.contains("active");s.currentTarget.classList.toggle("active",o),e?.(o,s)})}function X(c,t){return`<div class="tabs">${c.map(i=>`<button class="${i.id===t?"tab active":"tab"}" data-tab="${i.id}">${i.label}</button>`).join("")}</div>`}function j(c,t){c.querySelectorAll("[data-tab]").forEach(e=>{e.addEventListener("click",i=>{let s=i.currentTarget.dataset.tab;t?.(s,i)})})}function O(c,t,e){return`<div class="tab-panel${t?" active":""}" id="panel-${c}" ${t?"":"hidden"}>${e}</div>`}function bt({id:c="form-dialog",visible:t=!1,body:e="",submitLabel:i="Save",cancelLabel:s="Cancel",submitClass:o="btn btn-primary",cancelClass:n="btn btn-secondary"}={}){return`
    <div class="form-dialog" id="${c}" ${t?"":'style="display:none;"'}>
      ${e}
      <div class="form-actions">
        <button class="${n}" data-form-action="cancel">${s}</button>
        <button class="${o}" data-form-action="submit">${i}</button>
      </div>
    </div>`}function _t(c,t,{onCancel:e,onSubmit:i}={}){let s=c.getElementById(t);return s?(s.querySelector('[data-form-action="cancel"]')?.addEventListener("click",o=>{s.style.display="none",e?.(o)}),s.querySelector('[data-form-action="submit"]')?.addEventListener("click",o=>{i?.(o)}),{show(){s.style.display="block"},hide(){s.style.display="none"},el:s}):null}var vt=H("iPIXEL_SavedSlots",()=>({})),ii=[{value:1,name:"Style 1 (Digital)"},{value:2,name:"Style 2 (Minimal)"},{value:3,name:"Style 3 (Bold)"},{value:4,name:"Style 4 (Retro)"},{value:5,name:"Style 5 (Neon)"},{value:6,name:"Style 6 (Matrix)"},{value:7,name:"Style 7 (Classic)"},{value:8,name:"Style 8 (Modern)"}],Se=[{value:0,name:"Static"},{value:1,name:"Scroll Left"},{value:2,name:"Scroll Right"},{value:5,name:"Blink"},{value:6,name:"Breeze"},{value:7,name:"Snow"},{value:8,name:"Laser"}],Ee=[{value:"textimage",name:"Text+Image"},{value:"text",name:"Text"},{value:"clock",name:"Clock"},{value:"gif",name:"GIF"},{value:"rhythm",name:"Rhythm"}],si={text:"#ff6600",textimage:"#ff6600",clock:"#00ff88",gif:"#ff44ff",rhythm:"#44aaff"},Ft=[1,2,3,4,5,6,7,8,9],oi=[{id:"main",label:"Main"},{id:"clock",label:"Clock"},{id:"slots",label:"Slots"},{id:"advanced",label:"Advanced"}],ni='<svg viewBox="0 0 24 24"><path d="M13,3H11V13H13V3M17.83,5.17L16.41,6.59C18.05,7.91 19,9.9 19,12A7,7 0 0,1 12,19A7,7 0 0,1 5,12C5,9.9 5.95,7.91 7.59,6.59L6.17,5.17C4.23,6.82 3,9.26 3,12A9,9 0 0,0 12,21A9,9 0 0,0 21,12C21,9.26 19.77,6.82 17.83,5.17Z"/></svg>',ai='<svg viewBox="0 0 24 24"><path d="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z"/></svg>',ri='<svg viewBox="0 0 24 24"><path d="M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M16.2,16.2L11,13V7H12.5V12.2L17,14.9L16.2,16.2Z"/></svg>',li='<svg viewBox="0 0 24 24"><path d="M12,4V2A10,10 0 0,0 2,12H4A8,8 0 0,1 12,4M18.2,7.27L19.62,5.85C18.27,4.5 16.5,3.5 14.5,3.13V5.17C15.86,5.5 17.08,6.23 18.2,7.27M20,12H22A10,10 0 0,0 12,2V4A8,8 0 0,1 20,12M5.8,16.73L4.38,18.15C5.73,19.5 7.5,20.5 9.5,20.87V18.83C8.14,18.5 6.92,17.77 5.8,16.73M4,12H2A10,10 0 0,0 12,22V20A8,8 0 0,1 4,12Z"/></svg>',Bt=class extends R{constructor(){super(),this._activeTab="main",this._clockStyle=1,this._is24Hour=!0,this._showDate=!1,this._upsideDown=!1,this._animationMode=0,this._programSlots="",this._fontSize=16,this._fontOffsetX=0,this._fontOffsetY=0,this._saveSlotNum=1,this._saveType="gif",this._saveFrames=30,this._saveDelay=100}_switchTab(t){this._captureSlotsForm(),this._activeTab=t,this.render()}_captureSlotsForm(){let t=e=>this.shadowRoot.getElementById(e);t("font-size")&&(this._fontSize=parseInt(t("font-size").value)||this._fontSize),t("font-offset-x")&&(this._fontOffsetX=parseInt(t("font-offset-x").value)||0),t("font-offset-y")&&(this._fontOffsetY=parseInt(t("font-offset-y").value)||0),t("save-slot")&&(this._saveSlotNum=parseInt(t("save-slot").value)||1),t("save-type")&&(this._saveType=t("save-type").value||"gif"),t("save-frames")&&(this._saveFrames=parseInt(t("save-frames").value)||30),t("save-delay")&&(this._saveDelay=parseInt(t("save-delay").value)||100),t("program-slots")&&(this._programSlots=t("program-slots").value||"")}render(){let t=this.isInTestMode();if(!this._hass&&!t)return;let e=this.isOn(),i=this.getRelatedEntity("switch","_upside_down");i&&(this._upsideDown=i.state==="on");let s=this._activeTab;this.shadowRoot.innerHTML=`
      <style>${D}
      ...
      <div class="control-row">
        <div class="button-grid button-grid-4">
          <button class="icon-btn ${t?"active":""}" data-action="power" title="Power">${ni}</button>
          <button class="icon-btn" data-action="clear" title="Clear">${ai}</button>
          <button class="icon-btn" data-action="clock" title="Clock">${ri}</button>
          <button class="icon-btn" data-action="sync" title="Sync Time">${li}</button>
        </div>
      </div>

      <div class="section-title">Brightness</div>
      <div class="control-row">
        ${it({id:"brightness",min:1,max:100,value:50,unit:"%"})}
      </div>

      <div class="section-title">Display Mode</div>
      <div class="control-row">
        ${L(Ee,{selected:null,itemClass:"mode-btn",gridClass:"button-grid button-grid-3",dataAttr:"mode"})}
      ...
      <div class="subsection">
        <div class="compact-row" style="margin-bottom: 12px;">
          <select class="dropdown" id="clock-style">
            ${ii.map(t=>`<option value="${t.value}"${t.value===this._clockStyle?" selected":""}>${t.name}</option>`).join("")}
          </select>
          <button class="btn btn-primary" id="apply-clock-btn">Apply</button>
        </div>
        ${V({id:"toggle-24h",active:this._is24Hour,label:"24-Hour Format"})}
        ${V({id:"toggle-date",active:this._showDate,label:"Show Date"})}
      </div>

      <div class="section-title">Text Animation</div>
      <div class="control-row">
        <select class="dropdown" id="animation-mode">
          ${Se.map(t=>`<option value="${t.value}"${t.value===this._animationMode?" selected":""}>${t.name}</option>`).join("")}
        </select>
      </div>
      ...
      <div class="two-col">
        ...
        <div>
          ...
          ${V({id:"toggle-upside-down",active:this._upsideDown,label:"Upside Down",padding:"4px 0"})}
        </div>
      ...
      <div class="subsection">
        ...
        <div style="margin-bottom: 12px;">
          ${L(Ft.map(i=>({value:i,name:String(i)})),{selected:null,itemClass:"screen-btn",gridClass:"screen-grid",dataAttr:"screen"})}
        </div>
        ...
        ${L([...Ft,10].map(i=>({value:i,name:`\xD7${i}`})),{selected:null,itemClass:"screen-btn delete",gridClass:"screen-grid",dataAttr:"delete"})}
      </div>
      ...
      </div>`}_attachListeners(){j(this.shadowRoot,t=>this._switchTab(t)),this._attachMainTab(),this._attachClockTab(),this._attachSlotsTab(),this._attachAdvancedTab()}_attachMainTab(){this.shadowRoot.querySelectorAll("[data-action]").forEach(t=>{t.addEventListener("click",e=>this._handleAction(e.currentTarget.dataset.action))}),st(this.shadowRoot,"brightness",{unit:"%",onChange:t=>this.callService("ipixel_color","set_brightness",{level:t})}),A(this.shadowRoot,"[data-mode]",{onSelect:t=>this._selectMode(t),attr:"mode"})}_attachClockTab(){this.shadowRoot.getElementById("clock-style")?.addEventListener("change",t=>{this._clockStyle=parseInt(t.target.value)}),this.shadowRoot.getElementById("apply-clock-btn")?.addEventListener("click",()=>this._applyClockSettings()),G(this.shadowRoot,"toggle-24h",t=>{this._is24Hour=t}),G(this.shadowRoot,"toggle-date",t=>{this._showDate=t}),this.shadowRoot.getElementById("animation-mode")?.addEventListener("change",t=>{let e=parseInt(t.target.value);if(!Se.map(o=>o.value).includes(e)){_LOGGER.warn(`Unsupported animation mode ${e} \u2013 ignoring.`);return}this._animationMode=e,E({animationMode:this._animationMode});let s=F().text;s&&this.callService("ipixel_color","display_text",{text:s,effect:this._animationMode})}),this.shadowRoot.getElementById("orientation")?.addEventListener("change",t=>{let e=parseInt(t.target.value),i=this.getRelatedEntity("select","_orientation");i?this._hass.callService("select","select_option",{entity_id:i.entity_id,option:String(e*90)}):this.callService("ipixel_color","set_orientation",{orientation:e})}),G(this.shadowRoot,"toggle-upside-down",t=>{this._upsideDown=t;let e=this.getRelatedEntity("switch","_upside_down");e?this._hass.callService("switch",t?"turn_on":"turn_off",{entity_id:e.entity_id}):this.callService("ipixel_color","set_upside_down",{enabled:t})})}_attachSlotsTab(){A(this.shadowRoot,"[data-show-slot]",{onSelect:t=>this.callService("ipixel_color","show_slot",{slot:parseInt(t)}),attr:"showSlot"}),this.shadowRoot.getElementById("program-mode-btn")?.addEventListener("click",()=>{let t=this.shadowRoot.getElementById("program-slots")?.value||"",e=t.split(/[,\s]+/).map(Number).filter(i=>i>=1&&i<=255);e.length&&(this._programSlots=t,this.callService("ipixel_color","set_program_mode",{buffers:e}))}),A(this.shadowRoot,"[data-screen]",{onSelect:t=>this.callService("ipixel_color","set_screen",{screen:parseInt(t)}),attr:"screen"}),this.shadowRoot.querySelectorAll("[data-delete]").forEach(t=>{t.addEventListener("click",e=>{let i=parseInt(e.currentTarget.dataset.delete);if(confirm(`Delete screen slot ${i}?`)){this.callService("ipixel_color","delete_slot",{slot:i});let s=vt.load();delete s[String(i)],vt.save(s),this.render()}})}),this.shadowRoot.getElementById("save-type")?.addEventListener("change",t=>{let e=this.shadowRoot.getElementById("save-gif-options");e&&(e.style.display=t.target.value==="gif"?"flex":"none")}),this.shadowRoot.getElementById("save-to-slot-btn")?.addEventListener("click",async()=>{await this._saveToSlot()}),this.shadowRoot.getElementById("font-size")?.addEventListener("change",t=>{let e=parseInt(t.target.value);E({fontSize:e}),this.callService("ipixel_color","set_font_size",{size:e})}),["font-offset-x","font-offset-y"].forEach(t=>{this.shadowRoot.getElementById(t)?.addEventListener("change",()=>this._updateFontOffset())})}_attachAdvancedTab(){this.shadowRoot.getElementById("diy-mode")?.addEventListener("change",e=>{let i=e.target.value;i!==""&&(this.callService("ipixel_color","set_diy_mode",{mode:i}),setTimeout(()=>{e.target.value=""},500))});let t=()=>{let e=this.shadowRoot.getElementById("raw-command")?.value?.trim();e&&this.callService("ipixel_color","send_raw_command",{hex_data:e})};this.shadowRoot.getElementById("send-raw-btn")?.addEventListener("click",t),this.shadowRoot.getElementById("raw-command")?.addEventListener("keypress",e=>{e.key==="Enter"&&t()})}_handleAction(t){if(t==="power"){let e=this.getRelatedEntity("switch");e&&this._hass.callService("switch","toggle",{entity_id:e.entity_id})}else t==="clear"?(E({text:"",mode:"text",effect:"fixed",speed:50,fgColor:"#ff6600",bgColor:"#000000"}),this.callService("ipixel_color","clear_pixels")):t==="clock"?this._applyClockSettings():t==="sync"&&this.callService("ipixel_color","sync_time")}_selectMode(t){if(!Ee.map(s=>s.value).includes(t)){_LOGGER.warn(`Attempted to select unsupported mode "${t}" \u2013 ignoring.`);return}let i=this.getRelatedEntity("select","_mode");i&&this._hass.callService("select","select_option",{entity_id:i.entity_id,option:t}),E({mode:t,fgColor:si[t]||"#ff6600",text:t==="clock"?"":window.iPIXELDisplayState?.text||""})}_applyClockSettings(){E({text:"",mode:"clock",effect:"fixed",speed:50,fgColor:"#00ff88",bgColor:"#000000",clockStyle:this._clockStyle,is24Hour:this._is24Hour,showDate:this._showDate}),this.callService("ipixel_color","set_clock_mode",{style:this._clockStyle,format_24h:this._is24Hour,show_date:this._showDate})}_updateFontOffset(){let t=parseInt(this.shadowRoot.getElementById("font-offset-x")?.value||"0"),e=parseInt(this.shadowRoot.getElementById("font-offset-y")?.value||"0");E({fontOffsetX:t,fontOffsetY:e}),this.callService("ipixel_color","set_font_offset",{x:t,y:e})}async _saveToSlot(){let t=a=>this.shadowRoot.getElementById(a),e=parseInt(t("save-slot")?.value||"1"),i=t("save-type")?.value||"gif",s=parseInt(t("save-frames")?.value||"30"),o=parseInt(t("save-delay")?.value||"100"),n=t("save-progress"),r=t("save-to-slot-btn");n&&(n.style.display="block",n.textContent="Starting..."),r&&(r.disabled=!0);try{await this.callService("ipixel_color","save_to_slot",{slot:e,type:i,frames:s,delay:o});let a=window.iPIXELDisplayState||{},l=vt.load();l[String(e)]={name:a.text||a.effect||i,type:i,frames:i==="gif"?s:1,savedAt:new Date().toISOString()},vt.save(l),n&&(n.textContent="Saved!"),setTimeout(()=>this.render(),1500)}catch(a){n&&(n.textContent="Error: "+a.message)}finally{r&&(r.disabled=!1)}}static getConfigElement(){return document.createElement("ipixel-simple-editor")}static getStubConfig(){return{entity:""}}};var ci=[{value:0,name:"None"},{value:1,name:"Rainbow Wave"},{value:2,name:"Rainbow Cycle"},{value:3,name:"Rainbow Pulse"},{value:4,name:"Rainbow Fade"},{value:5,name:"Rainbow Chase"},{value:6,name:"Rainbow Sparkle"},{value:7,name:"Rainbow Gradient"},{value:8,name:"Rainbow Theater"},{value:9,name:"Rainbow Fire"}],di=[{value:0,name:"Classic Bars"},{value:1,name:"Mirrored Bars"},{value:2,name:"Center Out"},{value:3,name:"Wave Style"},{value:4,name:"Particle Style"}],hi=["32Hz","64Hz","125Hz","250Hz","500Hz","1kHz","2kHz","4kHz","8kHz","12kHz","16kHz"],fi=[{id:"text",label:"Text"},{id:"ambient",label:"Ambient"},{id:"rhythm",label:"Rhythm"},{id:"advanced",label:"GFX"}],zt=class extends R{constructor(){super(),this._activeTab="text",this._rhythmLevels=new Array(11).fill(0),this._selectedRhythmStyle=0,this._selectedAmbient="rainbow"}_ambientItems(){return Object.entries($).filter(([t,e])=>e.category===z.AMBIENT).map(([t,e])=>({value:t,name:e.name}))}_buildTextEffectOptions(){let t=e=>Object.entries($).filter(([i,s])=>s.category===e).map(([i,s])=>`<option value="${i}">${s.name}</option>`).join("");return`
      <optgroup label="Text Effects">${t(z.TEXT)}</optgroup>
      <optgroup label="Color Effects">${t(z.COLOR)}</optgroup>`}_renderTextTab(){return`
        ...
        <div>
          ...
          <div class="control-row">
            <select class="dropdown" id="rainbow-mode">
              ${ci.map(t=>`<option value="${t.value}">${t.name}</option>`).join("")}
            </select>
          </div>
        </div>
      </div>
      ...
      <div class="control-row">
        ${it({id:"text-speed",min:1,max:100,value:50})}
      </div>
      ...
      <div class="control-row">
        ${Kt([{id:"text-color",label:"Text",value:"#ff6600"},{id:"bg-color",label:"Background",value:"#000000"}])}
      ...
      <div class="section-title">Speed</div>
      <div class="control-row">
        ${it({id:"ambient-speed",min:1,max:100,value:50})}
      </div>
      ...
      ${L(di,{selected:this._selectedRhythmStyle,itemClass:"style-btn",gridClass:"style-grid",dataAttr:"style"})}
...
Example:
{
  ...
  "pixels": [
    ...
    {"x": 1, "y": 0, "color": "#00ff00"}
      ...
      </ha-card>`,this._attachListeners()}_getTextFormValues(){let t=e=>this.shadowRoot.getElementById(e);return{text:t("text-input")?.value||"",effect:t("text-effect")?.value||"fixed",rainbowMode:parseInt(t("rainbow-mode")?.value||"0"),speed:parseInt(t("text-speed")?.value||"50"),fgColor:t("text-color")?.value||"#ff6600",bgColor:t("bg-color")?.value||"#000000",font:t("font-select")?.value||"VCR_OSD_MONO"}}_getAmbientFormValues(){return{effect:this._selectedAmbient||"rainbow",speed:parseInt(this.shadowRoot.getElementById("ambient-speed")?.value||"50")}}_getRhythmFormValues(){return{style:this._selectedRhythmStyle||0,levels:[...this._rhythmLevels]}}_getGfxFormValues(){try{return JSON.parse(this.shadowRoot.getElementById("gfx-json")?.value||"")}catch{return null}}_getMulticolorFormValues(){let t=this.shadowRoot.getElementById("multicolor-text")?.value||"",e=(this.shadowRoot.getElementById("multicolor-colors")?.value||"").split(",").map(i=>i.trim()).filter(Boolean);return{text:t,colors:e}}_updateTextPreview(){let{text:t,effect:e,speed:i,fgColor:s,bgColor:o,font:n}=this._getTextFormValues();E({text:t||"Preview",mode:"text",effect:e,speed:i,fgColor:s,bgColor:o,font:n})}_updateAmbientPreview(){let{effect:t,speed:e}=this._getAmbientFormValues();E({text:"",mode:"ambient",effect:t,speed:e,fgColor:"#ffffff",bgColor:"#000000"})}_attachListeners(){j(this.shadowRoot,t=>{this._activeTab=t,this.render()}),st(this.shadowRoot,"text-speed",{onInput:()=>this._updateTextPreview()}),["text-effect","rainbow-mode","font-select"].forEach(t=>{this.shadowRoot.getElementById(t)?.addEventListener("change",()=>this._updateTextPreview())}),Zt(this.shadowRoot,["text-color","bg-color"],()=>this._updateTextPreview()),this.shadowRoot.getElementById("text-input")?.addEventListener("input",()=>this._updateTextPreview()),this.shadowRoot.getElementById("send-btn")?.addEventListener("click",()=>this._sendText()),A(this.shadowRoot,".effect-btn",{onSelect:t=>{this._selectedAmbient=t,this._updateAmbientPreview()},attr:"effect"}),st(this.shadowRoot,"ambient-speed",{onInput:()=>this._updateAmbientPreview()}),this.shadowRoot.getElementById("apply-ambient-btn")?.addEventListener("click",()=>{let{effect:t,speed:e}=this._getAmbientFormValues();E({text:"",mode:"ambient",effect:t,speed:e,fgColor:"#ffffff",bgColor:"#000000"})}),A(this.shadowRoot,".style-btn",{onSelect:t=>{this._selectedRhythmStyle=parseInt(t)},attr:"style"}),this.shadowRoot.querySelectorAll(".rhythm-slider").forEach(t=>{t.addEventListener("input",e=>{let i=parseInt(e.target.dataset.band),s=parseInt(e.target.value);this._rhythmLevels[i]=s,e.target.nextElementSibling.textContent=s})}),this.shadowRoot.getElementById("apply-rhythm-btn")?.addEventListener("click",()=>{let{style:t,levels:e}=this._getRhythmFormValues();E({text:"",mode:"rhythm",rhythmStyle:t,rhythmLevels:e}),this.callService("ipixel_color","set_rhythm_mode_advanced",{style:t,levels:e.join(",")})}),this.shadowRoot.getElementById("apply-gfx-btn")?.addEventListener("click",()=>{let t=this._getGfxFormValues();if(!t){console.warn("iPIXEL: Invalid GFX JSON");return}E({text:"",mode:"gfx",gfxData:t}),this.callService("ipixel_color","render_gfx",{data:t})}),this.shadowRoot.getElementById("apply-multicolor-btn")?.addEventListener("click",()=>{let{text:t,colors:e}=this._getMulticolorFormValues();!t||!e.length||(E({text:t,mode:"multicolor",colors:e}),this.callService("ipixel_color","display_multicolor_text",{text:t,colors:e.map(i=>this.hexToRgb(i))}))})}_sendText(){let{text:t,effect:e,rainbowMode:i,speed:s,fgColor:o,bgColor:n,font:r}=this._getTextFormValues();if(!t||(E({text:t,mode:"text",effect:e,speed:s,fgColor:o,bgColor:n,font:r,rainbowMode:i}),this.isInTestMode()))return;this._config.entity&&this._hass&&this._hass.callService("text","set_value",{entity_id:this._config.entity,value:t});let a=r==="LEGACY"?"CUSONG":r;this.callService("ipixel_color","display_text",{text:t,effect:e,speed:s,color_fg:this.hexToRgb(o),color_bg:this.hexToRgb(n),font:a,rainbow_mode:i})}static getConfigElement(){return document.createElement("ipixel-simple-editor")}static getStubConfig(){return{entity:""}}};var Qt=H("iPIXEL_Presets",()=>[]),te=["\u{1F4FA}","\u{1F4AC}","\u23F0","\u{1F3B5}","\u{1F3A8}","\u2B50","\u2764\uFE0F","\u{1F525}","\u{1F4A1}","\u{1F308}","\u{1F3AE}","\u{1F4E2}","\u{1F3E0}","\u{1F514}","\u2728","\u{1F389}"],pi='<svg width="16" height="16" viewBox="0 0 24 24"><path fill="currentColor" d="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z"/></svg>',ui='<svg width="16" height="16" viewBox="0 0 24 24"><path fill="currentColor" d="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z"/></svg>',Ht=class extends R{constructor(){super(),this._presets=Qt.load(),this._editingPreset=null,this._selectedIcon=te[0],this._formVisible=!1}render(){let t=this.isInTestMode();if(!this._hass&&!t)return;let e=te.map(i=>({value:i,name:i}));this.shadowRoot.innerHTML=`
      <style>${D}
        .preset-list {
      ...
      <div class="preset-item" data-index="${e}">
        ...
        <div class="preset-actions">
          <button data-action="edit" data-index="${e}" title="Edit">${pi}</button>
          <button class="delete" data-action="delete" data-index="${e}" title="Delete">${ui}</button>
        </div>
      </div>`}_showForm(t=null,e=null){this._editingPreset=e,this._selectedIcon=t?.icon||te[0],this._formVisible=!0,this.render();let i=this.shadowRoot.getElementById("preset-name");i&&(i.value=t?.name||"")}_applyPreset(t,e){E({text:t.text,mode:t.mode,effect:t.effect,speed:t.speed,fgColor:t.fgColor,bgColor:t.bgColor,font:t.font,rainbowMode:t.rainbowMode}),t.mode==="text"&&t.text&&this.callService("ipixel_color","display_text",{text:t.text,effect:t.effect,speed:t.speed,color_fg:this.hexToRgb(t.fgColor),color_bg:this.hexToRgb(t.bgColor),font:t.font,rainbow_mode:t.rainbowMode}),this.shadowRoot.querySelectorAll(".preset-item").forEach(i=>i.classList.remove("active")),e.classList.add("active")}_attachListeners(){this.shadowRoot.getElementById("add-preset-btn")?.addEventListener("click",()=>this._showForm()),_t(this.shadowRoot,"preset-form",{onCancel:()=>{this._formVisible=!1,this._editingPreset=null},onSubmit:()=>this._savePreset()}),A(this.shadowRoot,".icon-option",{onSelect:t=>{this._selectedIcon=t},attr:"icon"}),this.shadowRoot.querySelectorAll(".preset-item").forEach(t=>{t.addEventListener("click",e=>{if(e.target.closest(".preset-actions"))return;let i=this._presets[parseInt(t.dataset.index)];i&&this._applyPreset(i,t)})}),this.shadowRoot.querySelectorAll('[data-action="edit"]').forEach(t=>{t.addEventListener("click",e=>{e.stopPropagation();let i=parseInt(e.currentTarget.dataset.index);this._showForm(this._presets[i],i)})}),this.shadowRoot.querySelectorAll('[data-action="delete"]').forEach(t=>{t.addEventListener("click",e=>{e.stopPropagation();let i=parseInt(e.currentTarget.dataset.index);confirm("Delete this preset?")&&(this._presets.splice(i,1),Qt.save(this._presets),this.render())})})}_savePreset(){let t=(this.shadowRoot.getElementById("preset-name")?.value||"").trim()||"Preset",e=F(),i={name:t,icon:this._selectedIcon,text:e.text||"",mode:e.mode||"text",effect:e.effect||"fixed",speed:e.speed||50,fgColor:e.fgColor||"#ff6600",bgColor:e.bgColor||"#000000",font:e.font||"VCR_OSD_MONO",rainbowMode:e.rainbowMode||0,createdAt:Date.now()};this._editingPreset!==null?this._presets[this._editingPreset]=i:this._presets.push(i),Qt.save(this._presets),this._formVisible=!1,this._editingPreset=null,this.render()}static getConfigElement(){return document.createElement("ipixel-simple-editor")}static getStubConfig(){return{entity:""}}};var Nt=H("iPIXEL_Schedules",()=>[]),Ce=H("iPIXEL_PowerSchedule",()=>({enabled:!1,onTime:"07:00",offTime:"22:00"})),Ie=["Su","Mo","Tu","We","Th","Fr","Sa"],gi=[{id:"timeline",label:"Timeline"},{id:"power",label:"Power"},{id:"content",label:"Content"}],mi='<svg width="16" height="16" viewBox="0 0 24 24"><path fill="currentColor" d="M20.71,7.04C21.1,6.65 21.1,6 20.71,5.63L18.37,3.29C18,2.9 17.35,2.9 16.96,3.29L15.12,5.12L18.87,8.87M3,17.25V21H6.75L17.81,9.93L14.06,6.18L3,17.25Z"/></svg>',bi='<svg width="16" height="16" viewBox="0 0 24 24"><path fill="currentColor" d="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z"/></svg>',Vt=class extends R{constructor(){super(),this._activeTab="timeline",this._schedules=Nt.load(),this._powerSchedule=Ce.load(),this._editingSlot=null,this._formVisible=!1,this._checkInterval=null}connectedCallback(){this._checkInterval=setInterval(()=>this._checkSchedules(),6e4),this._checkSchedules()}disconnectedCallback(){super.disconnectedCallback(),this._checkInterval&&clearInterval(this._checkInterval)}_checkSchedules(){let t=new Date,e=this._formatTime(t),i=t.getDay();for(let s of this._schedules)s.enabled&&(s.days&&!s.days.includes(i)||s.startTime===e&&(E({text:s.text||"",mode:s.mode||"text",effect:s.effect||"fixed",fgColor:s.fgColor||"#ff6600",bgColor:s.bgColor||"#000000"}),s.mode==="text"&&s.text?this.callService("ipixel_color","display_text",{text:s.text,effect:s.effect,color_fg:this.hexToRgb(s.fgColor),color_bg:this.hexToRgb(s.bgColor)}):s.mode==="clock"&&this.callService("ipixel_color","set_clock_mode",{style:1})))}_formatTime(t){return`${String(t.getHours()).padStart(2,"0")}:${String(t.getMinutes()).padStart(2,"0")}`}_timeToMinutes(t){let[e,i]=t.split(":").map(Number);return e*60+i}render(){let t=this.isInTestMode();if(!this._hass&&!t)return;let e=this._activeTab;this.shadowRoot.innerHTML=`
      <style>${D}
      ...
      <div class="subsection">
        <div class="power-row">
          ${V({id:"power-toggle",active:this._powerSchedule.enabled})}
          <label>On:</label>
      ...
      </div>`}_renderContentTab(){let t=Ie.map((e,i)=>({value:i,name:e}));return`
      ...
      ${bt({id:"slot-form",visible:this._formVisible,submitLabel:"Save Schedule",body:`
          ...
          </div>`})}`}_renderScheduleItem(t,e){let i=t.days?t.days.map(o=>Ie[o]).join(", "):"Daily",s=this.escapeHtml(t.name||`Schedule ${e+1}`);return`
    ...
    `,this._initCanvas(),this._attachListeners()}_initCanvas(){this._displayCanvas=this.shadowRoot.getElementById("editor-canvas"),this._displayCanvas&&(this._dctx=this._displayCanvas.getContext("2d"),(this._logicalCanvas.width!==this._width||this._logicalCanvas.height!==this._height)&&(this._logicalCanvas.width=this._width,this._logicalCanvas.height=this._height),this._updateDisplaySize(),this._renderDisplay(),this._initialized=!0)}_updateDisplaySize(){this._displayCanvas&&(this._displayCanvas.width=this._width*this._scale,this._displayCanvas.height=this._height*this._scale)}_renderDisplay(){if(!this._dctx||!this._ctx)return;this._updateDisplaySize(),this._dctx.fillStyle="#050608",this._dctx.fillRect(0,0,this._displayCanvas.width,this._displayCanvas.height);let t=this._ctx.getImageData(0,0,this._width,this._height).data,e=this._scale,i=e*.38;for(let s=0;s<this._height;s++)for(let o=0;o<this._width;o++){let n=(s*this._width+o)*4,r=t[n],a=t[n+1],l=t[n+2],h=t[n+3]===0,f=o*e,p=s*e,u=f+e/2,g=p+e/2;if(this._dctx.fillStyle=`rgb(${ot.r},${ot.g},${ot.b})`,this._dctx.fillRect(f,p,e,e),this._gridOn)if(h)this._dctx.fillStyle="rgb(5,5,5)",this._dctx.beginPath(),this._dctx.arc(u,g,i,0,Math.PI*2),this._dctx.fill();else{let b=this._dctx.createRadialGradient(u,g,i*.3,u,g,i*1.8);b.addColorStop(0,`rgba(${r},${a},${l},0.4)`),b.addColorStop(1,`rgba(${r},${a},${l},0)`),this._dctx.fillStyle=b,this._dctx.beginPath(),this._dctx.arc(u,g,i*1.8,0,Math.PI*2),this._dctx.fill(),this._dctx.fillStyle=`rgb(${r},${a},${l})`,this._dctx.beginPath(),this._dctx.arc(u,g,i,0,Math.PI*2),this._dctx.fill()}else h?this._dctx.fillStyle=`rgb(${ot.r},${ot.g},${ot.b})`:this._dctx.fillStyle=`rgb(${r},${a},${l})`,this._dctx.fillRect(f,p,e,e)}}_getPixelPos(t){if(!this._displayCanvas)return null;let e=this._displayCanvas.getBoundingClientRect(),i=e.width/this._width,s=e.height/this._height,o=t.touches?t.touches[0].clientX:t.clientX,n=t.touches?t.touches[0].clientY:t.clientY,r=Math.floor((o-e.left)/i),a=Math.floor((n-e.top)/s);return r<0||a<0||r>=this._width||a>=this._height?null:{x:r,y:a}}_drawAt(t){let e=this._getPixelPos(t);e&&(this._tool==="pen"?(this._ctx.fillStyle=this._currentColor,this._ctx.fillRect(e.x,e.y,1,1)):this._ctx.clearRect(e.x,e.y,1,1),this._renderDisplay())}_attachListeners(){let t=this.shadowRoot.getElementById("editor-canvas");if(!t)return;t.addEventListener("mousedown",i=>{i.preventDefault(),this._drawing=!0,this._drawAt(i)}),t.addEventListener("mousemove",i=>{this._drawing&&this._drawAt(i)}),window.addEventListener("mouseup",()=>{this._drawing=!1}),t.addEventListener("touchstart",i=>{i.preventDefault(),this._drawing=!0,this._drawAt(i)},{passive:!1}),t.addEventListener("touchmove",i=>{i.preventDefault(),this._drawing&&this._drawAt(i)},{passive:!1}),t.addEventListener("touchend",()=>{this._drawing=!1}),this.shadowRoot.getElementById("pen-tool")?.addEventListener("click",()=>{this._tool="pen",this.render()}),this.shadowRoot.getElementById("eraser-tool")?.addEventListener("click",()=>{this._tool="eraser",this.render()}),this.shadowRoot.getElementById("color-picker")?.addEventListener("input",i=>{this._currentColor=i.target.value,this._updatePaletteSelection()}),this.shadowRoot.querySelectorAll(".color-swatch").forEach(i=>{i.addEventListener("click",()=>{this._currentColor=i.dataset.color,this.shadowRoot.getElementById("color-picker").value=this._currentColor,this._updatePaletteSelection()})}),this.shadowRoot.getElementById("grid-toggle")?.addEventListener("click",()=>{this._gridOn=!this._gridOn,this.render()});let e=()=>{let i=parseInt(this.shadowRoot.getElementById("res-width")?.value,10),s=parseInt(this.shadowRoot.getElementById("res-height")?.value,10);i>0&&s>0&&(i!==this._width||s!==this._height)&&this._resizeCanvas(i,s)};this.shadowRoot.getElementById("res-width")?.addEventListener("change",e),this.shadowRoot.getElementById("res-height")?.addEventListener("change",e),A(this.shadowRoot,".preset-btn",{attr:"res",onSelect:i=>{let[s,o]=i.split("x").map(a=>parseInt(a,10));this._resizeCanvas(s,o);let n=this.shadowRoot.getElementById("res-width"),r=this.shadowRoot.getElementById("res-height");n&&(n.value=s),r&&(r.value=o)}}),this.shadowRoot.getElementById("clear-btn")?.addEventListener("click",()=>{this._clearCanvas()}),this.shadowRoot.getElementById("import-btn")?.addEventListener("click",()=>{this.shadowRoot.getElementById("file-input")?.click()}),this.shadowRoot.getElementById("file-input")?.addEventListener("change",i=>{let s=i.target.files?.[0];s&&this._handleImport(s)}),this.shadowRoot.getElementById("send-btn")?.addEventListener("click",()=>{this._sendToDevice()})}_updatePaletteSelection(){this.shadowRoot.querySelectorAll(".color-swatch").forEach(t=>{t.dataset.color.toLowerCase()===this._currentColor.toLowerCase()?t.classList.add("active"):t.classList.remove("active")})}_resizeCanvas(t,e){let i=this._ctx.getImageData(0,0,this._width,this._height);this._width=t,this._height=e,this._logicalCanvas.width=t,this._logicalCanvas.height=e,this._ctx.putImageData(i,0,0),this._updateDisplaySize(),this._renderDisplay();let s=this.shadowRoot.querySelector(".info-row span:first-child");s&&(s.textContent=`Tool: ${this._tool} | Grid: ${this._gridOn?"LED":"Flat"}`)}_clearCanvas(){this._ctx.clearRect(0,0,this._width,this._height),this._renderDisplay()}_handleImport(t){let e=new FileReader;e.onload=i=>{let s=new Image;s.onload=()=>{this._ctx.clearRect(0,0,this._width,this._height),this._ctx.imageSmoothingEnabled=!1,this._ctx.drawImage(s,0,0,this._width,this._height),this._renderDisplay()},s.src=i.target.result},e.readAsDataURL(t)}async _sendToDevice(){if(!this._sending){this._sending=!0,this.render();try{let t=this._ctx.getImageData(0,0,this._width,this._height).data,e=[];for(let i=0;i<this._height;i++)for(let s=0;s<this._width;s++){let o=(i*this._width+s)*4,n=t[o],r=t[o+1],a=t[o+2];t[o+3]>0&&e.push({x:s,y:i,color:this.rgbToHex(n,r,a).slice(1)})}e.length>0&&await this.callService("ipixel_color","set_pixels",{pixels:e})}catch(t){console.error("Failed to send pixels to device:",t)}finally{this._sending=!1,this.render()}}}static getConfigElement(){return document.createElement("ipixel-simple-editor")}static getStubConfig(){return{entity:""}}getCardSize(){return 4}};var Ls=B.prototype.playFrames,Te=typeof window<"u"&&(typeof window.hassConnection<"u"||document.querySelector("home-assistant")!==null),ee=Te?"/ipixel_color/gallery":`${window.location.pathname.substring(0,window.location.pathname.lastIndexOf("/")+1)}gallery`,nt=H("iPIXEL_UserGIFs",()=>[]),xi=[{id:"browse",label:"Browse"},{id:"upload",label:"Upload"}],Xt=class extends R{constructor(){super(),this._activeTab="browse",this._manifest=null,this._loading=!1,this._selectedSize=null,this._filter="all",this._sending=null,this._slotMode=!1,this._targetSlot=1,this._dragOver=!1}connectedCallback(){this._loadManifest()}async _loadManifest(){if(!this._manifest){this._loading=!0,this.render();try{let t=await fetch(`${ee}/manifest.json`);this._manifest=await t.json(),this._autoSelectSize()}catch(t){console.error("iPIXEL Gallery: Failed to load manifest",t),this._manifest={}}this._loading=!1,this.render()}}_autoSelectSize(){if(!this._manifest)return;let[t,e]=this.getResolution(),i=`${t}x${e}`;if(this._manifest[i])this._selectedSize=i;else{let s=Object.keys(this._manifest);this._selectedSize=s.length>0?s[0]:null}}_getSortedSizes(){return this._manifest?Object.keys(this._manifest).sort((t,e)=>{let[i,s]=t.split("x").map(Number),[o,n]=e.split("x").map(Number);return s-n||i-o}):[]}_getItems(){let t=nt.load();if(!this._manifest||!this._selectedSize)return this._filter==="user"||this._filter==="all"?t.map(o=>({...o,type:"user"})):[];let e=this._manifest[this._selectedSize],i=[];return this._filter!=="user"&&((this._filter==="all"||this._filter==="animations")&&(e?.animations||[]).forEach(o=>i.push({...o,type:"bundled"})),(this._filter==="all"||this._filter==="eyes")&&(e?.eyes||[]).forEach(o=>i.push({...o,type:"bundled"}))),[...this._filter==="all"||this._filter==="user"?t.map(o=>({...o,type:"user"})):[],...i]}async _playGifOnPreview(t){let i=document.querySelector("ipixel-display-card")?._renderer;if(!i){console.warn("iPIXEL Gallery: No display renderer found for preview");return}let s=120,o=i.width,n=i.height;try{let a=await(await fetch(t)).blob(),{frames:l,avgDelay:d}=await this._decodeGifFrames(a,o,n,s);i.stopFrames?.(),i.stop(),l.length>1&&i.playFrames?i.playFrames(l,Math.max(20,d)):l.length>0&&(i.setData(l[0]),i.setEffect("fixed",50),i.renderStatic())}catch(r){console.error("iPIXEL Gallery: GIF preview failed",r)}}async _decodeGifFrames(t,e,i,s){let o=[],n=100,r=(a,l,d,h)=>h<128?"#000000":"#"+a.toString(16).padStart(2,"0")+l.toString(16).padStart(2,"0")+d.toString(16).padStart(2,"0");if(typeof ImageDecoder<"u"){let a=new ImageDecoder({data:await t.arrayBuffer(),type:"image/gif"});await a.tracks.ready;let l=Math.min(a.tracks.selectedTrack.frameCount,s),h=new OffscreenCanvas(e,i).getContext("2d",{willReadFrequently:!0});for(let f=0;f<l;f++){let p=await a.decode({frameIndex:f});h.imageSmoothingEnabled=!1,h.clearRect(0,0,e,i),h.drawImage(p.image,0,0,e,i),f===0&&p.image.duration&&(n=p.image.duration/1e3);let u=h.getImageData(0,0,e,i).data,g=[];for(let b=0;b<e*i;b++)g.push(r(u[b*4],u[b*4+1],u[b*4+2],u[b*4+3]));o.push(g),p.image.close()}a.close()}else{let a=new Image;a.src=URL.createObjectURL(t),await new Promise((p,u)=>{a.onload=p,a.onerror=u});let l=document.createElement("canvas");l.width=e,l.height=i;let d=l.getContext("2d");d.imageSmoothingEnabled=!1,d.drawImage(a,0,0,e,i);let h=d.getImageData(0,0,e,i).data,f=[];for(let p=0;p<e*i;p++)f.push(r(h[p*4],h[p*4+1],h[p*4+2],h[p*4+3]));o.push(f),URL.revokeObjectURL(a.src)}return{frames:o,avgDelay:n}}async _sendToDevice(t){this._sending=t.name||t.file,this.render();let e=t.type==="user"?t.dataUrl:`${ee}/${this._selectedSize}/${t.file}`;(t.type==="user"||Te)&&this._playGifOnPreview(e);try{if(t.type==="user")await this._sendUserGif(t);else{let i={entity_id:this._config.entity,size:this._selectedSize,filename:t.file};this._slotMode&&(i.buffer_slot=this._targetSlot),await this.callService("ipixel_color","display_local_gallery",i)}}catch(i){console.error("iPIXEL Gallery: Send failed",i)}this._sending=null,this.render()}async _sendUserGif(t){let i=await(await fetch(t.dataUrl)).blob();if(window.iPIXEL_BLE&&window.iPIXEL_BLE.isConnected()){let s=new Uint8Array(await i.arrayBuffer()),o=this._slotMode?this._targetSlot:1;await window.iPIXEL_BLE.saveGifToSlot(o,s)}else{console.warn("iPIXEL Gallery: User GIF send requires BLE connection or HA backend support");let s={gif_url:t.dataUrl};this._slotMode&&(s.buffer_slot=this._targetSlot),await this.callService("ipixel_color","upload_gif",s)}}_handleFiles(t){let e=nt.load(),i=0,s=0;for(let o of t){if(!o.type.startsWith("image/"))continue;i++;let n=new FileReader;n.onload=()=>{let r=e.findIndex(l=>l.name===o.name),a={name:o.name,dataUrl:n.result,addedAt:Date.now()};r>=0?e[r]=a:e.push(a),++s===i&&(nt.save(e),this.render())},n.readAsDataURL(o)}}render(){let t=this.isInTestMode();if(!this._hass&&!t)return;let e=this._activeTab;this.shadowRoot.innerHTML=`
      ...
      </ha-card>`,this._attachListeners()}_renderBrowseTab(){if(this._loading)return'<div class="empty-state">Loading gallery...</div>';let t=this._getSortedSizes(),e=this._manifest?.[this._selectedSize],i=(e?.animations?.length||0)>0,s=(e?.eyes?.length||0)>0,o=nt.load(),[n,r]=this.getResolution(),a=t.map(d=>({value:d,name:d,isMatch:d===`${n}x${r}`})),l=[{value:"all",name:"All",show:!0},{value:"animations",name:"Animations",show:i},{value:"eyes",name:"Eyes",show:s},{value:"user",name:`My GIFs${o.length?` (${o.length})`:""}`,show:!0}].filter(d=>d.show);return`
      ${t.length>0?`
      ...
      ${L(l,{selected:this._filter,itemClass:"filter-btn",gridClass:"filter-row",dataAttr:"filter"})}
      ...
      <div class="slot-row">
        ${V({id:"slot-toggle",active:this._slotMode})}
      ...
      </div>`:`<div class="gallery-grid">${t.map(e=>{let i=e.name||e.file,s=this._sending===i,o=e.type==="user",n=o?e.name.replace(/\.[^.]+$/,""):e.side?`Eye ${e.side.toUpperCase()} #${e.num}`:`#${e.num}`,r=o?e.dataUrl:`${ee}/${this._selectedSize}/${e.file}`;return`
        ...
        </div>`}).join("")}</div>`}_attachListeners(){j(this.shadowRoot,e=>{this._activeTab=e,this.render()}),A(this.shadowRoot,".size-btn",{onSelect:e=>{this._selectedSize=e,this._filter="all",this.render()},attr:"size"}),A(this.shadowRoot,".filter-btn",{onSelect:e=>{this._filter=e,this.render()},attr:"filter"}),G(this.shadowRoot,"slot-toggle",e=>{this._slotMode=e,this.render()}),this.shadowRoot.getElementById("target-slot")?.addEventListener("change",e=>{this._targetSlot=parseInt(e.target.value)});let t=this.shadowRoot.getElementById("drop-zone");t&&(t.addEventListener("dragover",e=>{e.preventDefault(),e.stopPropagation(),this._dragOver||(this._dragOver=!0,t.classList.add("drag-over"))}),t.addEventListener("dragleave",e=>{e.preventDefault(),e.stopPropagation(),this._dragOver=!1,t.classList.remove("drag-over")}),t.addEventListener("drop",e=>{e.preventDefault(),e.stopPropagation(),this._dragOver=!1,e.dataTransfer?.files?.length&&this._handleFiles(e.dataTransfer.files)}),t.addEventListener("click",()=>{this.shadowRoot.getElementById("file-input")?.click()})),this.shadowRoot.getElementById("file-input")?.addEventListener("change",e=>{e.target.files?.length&&this._handleFiles(e.target.files)}),this.shadowRoot.querySelectorAll(".gallery-item").forEach(e=>{e.addEventListener("click",i=>{if(i.target.classList.contains("delete-btn"))return;let s=e.dataset.id,o=this._getItems().find(n=>(n.name||n.file)===s);o&&!this._sending&&this._sendToDevice(o)})}),this.shadowRoot.querySelectorAll("[data-delete]").forEach(e=>{e.addEventListener("click",i=>{i.stopPropagation();let s=i.currentTarget.dataset.delete,o=nt.load().filter(n=>n.name!==s);nt.save(o),this.render()})})}static getConfigElement(){return document.createElement("ipixel-simple-editor")}static getStubConfig(){return{entity:""}}};var yi=typeof window<"u"&&(typeof window.hassConnection<"u"||document.querySelector("home-assistant")!==null);if(yi)Z({ttfResolver:c=>`/hacsfiles/ipixel_color/fonts/${c}.ttf`,bdfResolver:(c,t)=>`/hacsfiles/ipixel_color/fonts/${t||c}`});else if(typeof window<"u"){let c=window.location.pathname.substring(0,window.location.pathname.lastIndexOf("/")+1);Z({baseUrl:`${c}fonts`})}var jt=new Map,Ut=class extends R{constructor(){super(),this._renderer=null,this._displayContainer=null,this._lastState=null,this._cachedResolution=null,this._rendererId=null,this._activeTab="quick",this._selectedAmbient="rainbow",this._rhythmLevels=new Array(11).fill(0),this._selectedRhythmStyle=0,this._handleDisplayUpdate=t=>{this._updateDisplay(t.detail)},window.addEventListener("ipixel-display-update",this._handleDisplayUpdate)}connectedCallback(){this._rendererId||(this._rendererId=`renderer_${Date.now()}_${Math.random().toString(36).substr(2,9)}`),jt.has(this._rendererId)&&(this._renderer=jt.get(this._rendererId)),P("VCR_OSD_MONO",16).then(()=>{this._lastState&&this._updateDisplay(this._lastState)}),P("VCR_OSD_MONO",24),P("VCR_OSD_MONO",32),P("CUSONG",16),P("CUSONG",24),P("CUSONG",32),N("VCR_OSD_MONO"),N("CUSONG")}_getFormHash(){let t=F();return[t.text,t.effect,t.speed,t.fgColor,t.bgColor,t.mode,t.font,t.rainbowMode,this._activeTab,this._selectedAmbient,this._selectedRhythmStyle,this._rhythmLevels.join(",")].join("|")}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("ipixel-display-update",this._handleDisplayUpdate),this._renderer&&this._rendererId&&(this._renderer.stop(),jt.set(this._rendererId,this._renderer))}_getResolutionCached(){let[t,e]=this.getResolution();if(t>0&&e>0){this._cachedResolution=[t,e];try{localStorage.setItem("iPIXEL_Resolution",JSON.stringify([t,e]))}catch{}return this._cachedResolution}try{let i=localStorage.getItem("iPIXEL_Resolution");if(i){let s=JSON.parse(i);if(Array.isArray(s)&&s.length===2&&s[0]>0&&s[1]>0)return this._cachedResolution=s,s}}catch{}return this._cachedResolution?this._cachedResolution:this._config?.width&&this._config?.height?[this._config.width,this._config.height]:[t||64,e||16]}_updateDisplay(t){if(!this._displayContainer)return;let[e,i]=this._getResolutionCached(),s=this.isOn();if(this._renderer?(this._renderer.setContainer(this._displayContainer),(this._renderer.width!==e||this._renderer.height!==i)&&this._renderer.setDimensions(e,i)):(this._renderer=new B(this._displayContainer,{width:e,height:i}),this._rendererId&&jt.set(this._rendererId,this._renderer)),!s){this._renderer.setData([]),this._renderer.setEffect("fixed",50),this._renderer.stop(),this._renderer.renderStatic();return}let o=t?.text||"",n=t?.effect||"fixed",r=t?.speed||50,a=t?.fgColor||"#ff6600",l=t?.bgColor||"#000000",d=t?.mode||"text",h=t?.font||"VCR_OSD_MONO";this._lastState=t;let f=o,p=a;if(d==="clock"?(f=new Date().toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",hour12:!1}),p="#00ff88"):d==="gif"?(f="GIF",p="#ff44ff"):d==="rhythm"&&(f="***",p="#44aaff"),$[n]?.category==="ambient")this._renderer.setData([],[],e);else{let b=J(i),m=h!=="LEGACY"&&ut(h,b),x=h!=="LEGACY"&&K(h),_=(w,C,S,T,I)=>{if(m){let M=gt(w,C,S,T,I,h);if(M)return M}if(x){let M=ft(w,C,S,T,I,h);if(M)return M}return dt(w,C,S,T,I)},v=(w,C,S,T,I)=>{if(m){let M=mt(w,C,S,T,I,h);if(M)return M}if(x){let M=pt(w,C,S,T,I,h);if(M)return M}return ht(w,C,S,T,I)},y=x?f.length*10:f.length*6;if((n==="scroll_ltr"||n==="scroll_rtl"||n==="bounce")&&y>e){let w=v(f,e,i,p,l),C=_(f,e,i,p,l);this._renderer.setData(C,w.pixels,w.width)}else{let w=_(f,e,i,p,l);this._renderer.setData(w)}}this._renderer.setEffect(n,r),n==="fixed"?(this._renderer.stop(),this._renderer.renderStatic()):this._renderer.start()}_getTestModeState(){let t=[{text:"iPIXEL",effect:"scroll_ltr",speed:40,fgColor:"#ff6600",bgColor:"#000000",mode:"text",font:"VCR_OSD_MONO"},{text:"Hello!",effect:"rainbow_cycle",speed:50,fgColor:"#00ff88",bgColor:"#000000",mode:"text",font:"VCR_OSD_MONO"},{text:"TEST",effect:"fixed",speed:50,fgColor:"#03a9f4",bgColor:"#111111",mode:"text",font:"VCR_OSD_MONO"},{text:"",effect:"rainbow",speed:60,fgColor:"#ffffff",bgColor:"#000000",mode:"ambient",font:"VCR_OSD_MONO"}],e=Math.floor(Date.now()/1e4)%t.length;return t[e]}_callService(t,e={}){if(this._hass){if(this.isInTestMode()){console.info(`iPIXEL [Test Mode]: ipixel_color.${t}`,e);return}this.callService("ipixel_color",t,e)}}_sendText(){let t=this.shadowRoot.getElementById("control-text")?.value||"",e=this.shadowRoot.getElementById("control-effect")?.value||"fixed",i=parseInt(this.shadowRoot.getElementById("control-speed")?.value||"50"),s=this.shadowRoot.getElementById("control-fg-color")?.value||"#ff6600",o=this.shadowRoot.getElementById("control-bg-color")?.value||"#000000",n=this.shadowRoot.getElementById("control-font")?.value||"VCR_OSD_MONO",r=parseInt(this.shadowRoot.getElementById("control-rainbow")?.value||"0");t&&(E({text:t,mode:"text",effect:e,speed:i,fgColor:s,bgColor:o,font:n,rainbowMode:r}),this._callService("display_text",{text:t,effect:e,speed:i,color_fg:this.hexToRgb(s),color_bg:this.hexToRgb(o),font:n==="LEGACY"?"CUSONG":n,rainbow_mode:r}))}_applyAmbient(){let t=this._selectedAmbient||"rainbow",e=parseInt(this.shadowRoot.getElementById("ambient-speed")?.value||"50");E({text:"",mode:"ambient",effect:t,speed:e,fgColor:"#ffffff",bgColor:"#000000"}),this._callService("display_ambient",{effect:t,speed:e})}_applyRhythm(){let t=this._selectedRhythmStyle||0,e=this._rhythmLevels.join(",");E({text:"",mode:"rhythm",rhythmStyle:t,rhythmLevels:this._rhythmLevels}),this._callService("set_rhythm_mode_advanced",{style:t,levels:e})}_buildQuickActions(){return`
      <div class="subsection">
    ...
    `}_buildTextTab(){let t=F(),e=t.text||"",i=t.effect||"fixed",s=t.speed||50,o=t.fgColor||"#ff6600",n=t.bgColor||"#000000",r=t.font||"VCR_OSD_MONO",a=t.rainbowMode||0;return`
      <div class="subsection">
        ...
        <div class="two-col" style="margin-top:12px;">
          <div>
            ...
            <select class="dropdown" id="control-effect">
              ${Object.entries($).filter(([l,d])=>d.category===z.TEXT).map(([l,d])=>`<option value="${l}" ${l===i?"selected":""}>${d.name}</option>`).join("")}
            </select>
          </div>
          <div>
    ...
    `}_buildAmbientTab(){let t=Object.entries($).filter(([o,n])=>n.category===z.AMBIENT).map(([o,n])=>({value:o,name:n.name})),e=F(),i=e.effect||"rainbow",s=e.speed||50;return`
      <div class="subsection">
    ...
    `}_buildRhythmTab(){let t=[{value:0,name:"Classic Bars"},{value:1,name:"Mirrored Bars"},{value:2,name:"Center Out"},{value:3,name:"Wave Style"},{value:4,name:"Particle Style"}],e=["32Hz","64Hz","125Hz","250Hz","500Hz","1kHz","2kHz","4kHz","8kHz","12kHz","16kHz"],i=F(),s=i.rhythmStyle||0,o=i.rhythmLevels||new Array(11).fill(0);return`
      <div class="subsection">
    ...
    `}render(){let t=this.isInTestMode();if(!this._hass&&!t)return;let[e,i]=this._getResolutionCached(),s=this.isOn(),o=this._config.name||this.getEntity()?.attributes?.friendly_name||"iPIXEL Display",n=F(),a=this.getRelatedEntity("select","_mode")?.state||n.mode||"text",l=n.text||"Hello",d=n.effect||"fixed",h=n.speed||50,f=n.fgColor||"#ff6600",p=n.bgColor||"#000000",u=n.font||"VCR_OSD_MONO",g=this._getFormHash();if(g===this._lastFormHash&&this.shadowRoot.querySelector("ha-card")){this._updateDisplay({text:l,effect:d,speed:h,fgColor:f,bgColor:p,mode:a,font:u});return}this._lastFormHash=g;let b="";t?b=`
        <div class="test-mode-banner">
          <div class="test-mode-header">
            <span class="test-mode-label">Test Mode</span>
        ...
        </div>`;let m=Object.entries($).filter(([v,y])=>y.category===z.TEXT).map(([v,y])=>`<option value="${v}">${y.name}</option>`).join(""),x=Object.entries($).filter(([v,y])=>y.category===z.AMBIENT).map(([v,y])=>`<option value="${v}">${y.name}</option>`).join("");this.shadowRoot.innerHTML=`
      <style>${D}
        .display-container { background: #000; border-radius: 8px; padding: 8px; border: 2px solid #222; }
        .display-screen {
          background: #000;
      ...
      </ha-card>`,this._displayContainer=this.shadowRoot.getElementById("display-screen");let _=t&&!n.text&&n.effect==="fixed"?this._getTestModeState():{text:l,effect:d,speed:h,fgColor:f,bgColor:p,mode:a,font:u};this._updateDisplay(_),this._attachListeners(),this._restoreFormValues()}_restoreFormValues(){let t=F(),e=h=>this.shadowRoot.getElementById(h),i=e("control-text");i&&t.text&&(i.value=t.text);let s=e("control-effect");s&&t.effect&&(s.value=t.effect);let o=e("control-rainbow");o&&t.rainbowMode!==void 0&&(o.value=t.rainbowMode);let n=e("control-speed");if(n&&t.speed){n.value=t.speed;let h=e("control-speed-val");h&&(h.textContent=t.speed)}let r=e("control-font");r&&t.font&&(r.value=t.font);let a=e("control-fg-color");a&&t.fgColor&&(a.value=t.fgColor);let l=e("control-bg-color");l&&t.bgColor&&(l.value=t.bgColor);let d=e("ambient-speed");if(d&&t.speed){d.value=t.speed;let h=e("ambient-speed-val");h&&(h.textContent=t.speed)}this.shadowRoot.querySelectorAll("[data-ambient]").forEach(h=>{h.classList.toggle("active",h.dataset.ambient===t.effect)}),this.shadowRoot.querySelectorAll("[data-rhythm-style]").forEach(h=>{h.classList.toggle("active",parseInt(h.dataset.rhythmStyle)===t.rhythmStyle)}),t.rhythmLevels&&(this._rhythmLevels=[...t.rhythmLevels],this.shadowRoot.querySelectorAll(".rhythm-slider").forEach(h=>{let f=parseInt(h.dataset.band);if(t.rhythmLevels[f]!==void 0){h.value=t.rhythmLevels[f];let p=h.nextElementSibling;p&&(p.textContent=t.rhythmLevels[f])}}))}_attachListeners(){let t=i=>this.shadowRoot.getElementById(i);this.shadowRoot.querySelectorAll("[data-tab]").forEach(i=>{i.addEventListener("click",()=>{this._activeTab=i.dataset.tab,this.render()})}),t("power-btn")?.addEventListener("click",()=>{if(this.isInTestMode()){this._testPowerState=!this._testPowerState,this.render();return}let i=this._switchEntityId;if(!i){let s=this.getRelatedEntity("switch");s&&(this._switchEntityId=s.entity_id,i=s.entity_id)}if(i&&this._hass?.states[i])this._hass.callService("switch","toggle",{entity_id:i});else{let s=Object.keys(this._hass?.states||{}).filter(r=>r.startsWith("switch.")),o=this._config.entity?.replace(/^[^.]+\./,"").replace(/_?(text|display|gif_url)$/i,"")||"",n=s.find(r=>r.includes(o.substring(0,10)));n?(this._switchEntityId=n,this._hass.callService("switch","toggle",{entity_id:n})):console.warn("iPIXEL: No switch found. Entity:",this._config.entity,"Available:",s)}}),t("power-on-btn")?.addEventListener("click",()=>{let i=this.getRelatedEntity("switch");i&&this._hass.callService("switch","turn_on",{entity_id:i.entity_id})}),t("power-off-btn")?.addEventListener("click",()=>{let i=this.getRelatedEntity("switch");i&&this._hass.callService("switch","turn_off",{entity_id:i.entity_id})}),t("update-btn")?.addEventListener("click",()=>this._callService("update_display")),t("send-text-btn")?.addEventListener("click",()=>this._sendText()),t("control-speed")?.addEventListener("input",i=>{let s=i.target.value,o=t("control-speed-val");o&&(o.textContent=s);let n=t("control-text")?.value||"",r=t("control-effect")?.value||"fixed",a=t("control-fg-color")?.value||"#ff6600",l=t("control-bg-color")?.value||"#000000",d=t("control-font")?.value||"VCR_OSD_MONO";E({text:n,mode:"text",effect:r,speed:parseInt(s),fgColor:a,bgColor:l,font:d})}),t("control-text")?.addEventListener("input",i=>{let s=i.target.value||"",o=t("control-effect")?.value||"fixed",n=t("control-fg-color")?.value||"#ff6600",r=t("control-bg-color")?.value||"#000000",a=t("control-font")?.value||"VCR_OSD_MONO",l=parseInt(t("control-speed")?.value||"50");E({text:s,mode:"text",effect:o,speed:l,fgColor:n,bgColor:r,font:a})}),t("control-effect")?.addEventListener("change",i=>{let s=t("control-text")?.value||"",o=i.target.value||"fixed",n=t("control-fg-color")?.value||"#ff6600",r=t("control-bg-color")?.value||"#000000",a=t("control-font")?.value||"VCR_OSD_MONO",l=parseInt(t("control-speed")?.value||"50");E({text:s,mode:"text",effect:o,speed:l,fgColor:n,bgColor:r,font:a})}),t("control-rainbow")?.addEventListener("change",i=>{let s=t("control-text")?.value||"",o=t("control-effect")?.value||"fixed",n=t("control-fg-color")?.value||"#ff6600",r=t("control-bg-color")?.value||"#000000",a=t("control-font")?.value||"VCR_OSD_MONO",l=parseInt(t("control-speed")?.value||"50");E({text:s,mode:"text",effect:o,speed:l,fgColor:n,bgColor:r,font:a,rainbowMode:parseInt(i.target.value||"0")})}),t("control-font")?.addEventListener("change",i=>{let s=t("control-text")?.value||"",o=t("control-effect")?.value||"fixed",n=t("control-fg-color")?.value||"#ff6600",r=t("control-bg-color")?.value||"#000000",a=i.target.value||"VCR_OSD_MONO",l=parseInt(t("control-speed")?.value||"50");E({text:s,mode:"text",effect:o,speed:l,fgColor:n,bgColor:r,font:a})}),["control-fg-color","control-bg-color"].forEach(i=>{t(i)?.addEventListener("input",s=>{let o=t("control-text")?.value||"",n=t("control-effect")?.value||"fixed",r=t("control-fg-color")?.value||"#ff6600",a=t("control-bg-color")?.value||"#000000",l=t("control-font")?.value||"VCR_OSD_MONO",d=parseInt(t("control-speed")?.value||"50");E({text:o,mode:"text",effect:n,speed:d,fgColor:r,bgColor:a,font:l})})}),t("test-mode-toggle")?.addEventListener("click",()=>Et(!U())),this.shadowRoot.querySelectorAll("[data-mode]").forEach(i=>{i.addEventListener("click",()=>{let s=i.dataset.mode;if(E({mode:s}),s==="text"){let o=this.getRelatedEntity("select","_mode");o&&this._hass.callService("select","select_option",{entity_id:o.entity_id,option:"textimage"})}else if(s==="clock")this._callService("set_clock_mode",{style:1,show_date:!0,format_24:!0});else if(s==="gif"){let o=this.shadowRoot.getElementById("control-gif-url")?.value||"";o?this._callService("display_image_url",{url:o}):this._callService("display_local_gallery",{size:"64x64",filename:"yk_anim_en_64x64_1.gif",buffer_slot:1})}else s==="ambient"&&(this._selectedAmbient="rainbow",this._callService("display_ambient",{effect:"rainbow",speed:50}))})}),this.shadowRoot.querySelectorAll("[data-ambient]").forEach(i=>{i.addEventListener("click",()=>{this._selectedAmbient=i.dataset.ambient,E({mode:"ambient",effect:i.dataset.ambient}),this.render()})}),t("apply-ambient-btn")?.addEventListener("click",()=>this._applyAmbient()),this.shadowRoot.querySelectorAll("[data-rhythm-style]").forEach(i=>{i.addEventListener("click",()=>{this._selectedRhythmStyle=parseInt(i.dataset.rhythmStyle),E({mode:"rhythm",rhythmStyle:this._selectedRhythmStyle}),this.render()})}),this.shadowRoot.querySelectorAll(".rhythm-slider").forEach(i=>{i.addEventListener("input",s=>{let o=parseInt(s.target.dataset.band),n=parseInt(s.target.value);this._rhythmLevels[o]=n,s.target.nextElementSibling.textContent=n,E({mode:"rhythm",rhythmLevels:[...this._rhythmLevels]})})}),t("apply-rhythm-btn")?.addEventListener("click",()=>this._applyRhythm());let e=t("ambient-speed");e&&e.addEventListener("input",i=>{let s=i.target.value,o=t("ambient-speed-val");o&&(o.textContent=s),E({speed:parseInt(s)})})}static getConfigElement(){return document.createElement("ipixel-simple-editor")}static getStubConfig(){return{entity:""}}};var Wt=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"})}setConfig(t){this._config=t,this.render()}set hass(t){this._hass=t,this.render()}render(){if(!this._hass)return;let t=Object.keys(this._hass.states).filter(e=>e.startsWith("text.")||e.startsWith("switch.")).sort();this.shadowRoot.innerHTML=`
      <style>
      ...
      </div>`,this.shadowRoot.querySelectorAll("select, input").forEach(e=>{e.addEventListener("change",()=>this.fireConfig())})}fireConfig(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:{type:this._config?.type||"custom:ipixel-display-card",entity:this.shadowRoot.getElementById("entity")?.value,name:this.shadowRoot.getElementById("name")?.value||void 0}},bubbles:!0,composed:!0}))}};try{let c=(t,e)=>{customElements.get(t)||customElements.define(t,e)};c("ipixel-display-card",Dt),c("ipixel-controls-card",Bt),c("ipixel-text-card",zt),c("ipixel-playlist-card",Ht),c("ipixel-schedule-card",Vt),c("ipixel-editor-card",Gt),c("ipixel-gallery-card",Xt),c("ipixel-control-card",Ut),c("ipixel-simple-editor",Wt),window.customCards=window.customCards||[],[{type:"ipixel-display-card",name:"iPIXEL Display",description:"LED matrix preview with power control"},{type:"ipixel-controls-card",name:"iPIXEL Controls",description:"Brightness, mode, and orientation controls"},{type:"ipixel-text-card",name:"iPIXEL Text",description:"Text input with effects and colors"},{type:"ipixel-playlist-card",name:"iPIXEL Playlist",description:"Playlist management"},{type:"ipixel-schedule-card",name:"iPIXEL Schedule",description:"Power schedule and time slots"},{type:"ipixel-editor-card",name:"iPIXEL Pixel Editor",description:"Draw custom pixel art and send to your LED matrix"},{type:"ipixel-gallery-card",name:"iPIXEL Gallery",description:"Browse and send bundled animations to your LED matrix"},{type:"ipixel-control-card",name:"iPIXEL Control",description:"Unified control panel with preview and quick actions"}].forEach(t=>{try{window.customCards.push({...t,preview:!0,documentationURL:"https://github.com/cagcoach/ha-ipixel-color"})}catch(e){console.error("iPIXEL: failed to register card",t.type,e)}})}catch(c){console.error("iPIXEL: failed to initialize cards",c)}console.info(`%c iPIXEL Cards %c ${de} `,"background:#03a9f4;color:#fff;padding:2px 6px;border-radius:4px 0 0 4px;","background:#333;color:#fff;padding:2px 6px;border-radius:0 4px 4px 0;");})();
